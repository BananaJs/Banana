...
{};if(!a.paths.pages)a.paths.pages="Application.Pages";this.prepareUnload()},prepareUnload:function(){jQuery(window).unload(this.getProxy(function(){jQuery("*").unbind();this.activePage&&this.activePage.remove();this.pageTemplate&&this.pageTemplate.remove();Banana=null}))},loadPageTemplate:function(){if(this.settings.paths.pageTemplates)var a=this.settings.paths.pageTemplates+"."+this.settings.pageTemplate,b=Banana.Util.NamespaceToFunction(a);else log.warning("Path to page template "+this.settings.pageTemplate+
" not specified. Check application settings."),b=Banana.PageTemplate;if(b)try{this.pageTemplate=new b}catch(d){log.error("Error: could not instantiate template: "+a)}else log.error("Error: could not find Template: "+a)},getSettings:function(){return this.settings},setSectionVerticalScrollPosition:function(a){this.sectionVerticalScrollPosition[a]=window.scrollY},getSectionVerticalScrollPosition:function(a){return this.sectionVerticalScrollPosition[a]},loadPage:function(a,b,d){Banana.Util.UrlManager.saveModuleHistory("section");
this.setSectionVerticalScrollPosition(this.section);Banana.Util.UrlManager.clearUrl();if(this.loadingWithHistory=!d){var e=Banana.Util.UrlManager.getModuleHistory(a),f;for(f in e)e.hasOwnProperty(f)&&(Banana.Util.UrlManager.registerModule(f),Banana.Util.UrlManager.setModule(f,e[f],!0))}if(b)for(var g in b)b.hasOwnProperty(g)&&(Banana.Util.UrlManager.registerModule(g),Banana.Util.UrlManager.setModule(g,b[g],!0));this.run(a);d||window.scrollTo(0,this.getSectionVerticalScrollPosition(a)||0)},instantiateSinglePage:function(){this.pageTemplate||
this.loadPageTemplate();this.page.bind("renderComplete",this.getProxy(function(){if(this.activePage)this.activePage.removeDom(),this.activePage.clearProps(),this.activePage=void 0;this.activePage=this.page;this.activePage.setVisible(!0)}));this.page.setVisible(!1);this.pageTemplate.addPageControl(this.page);this.pageTemplate.setApplication(this);this.pageTemplate.run(this)},run:function(a){if(a)this.page=a;if(a instanceof Banana.Page)return this.instantiateSinglePage();this.triggerEvent("onPreLoadPage");
this.activePage||Banana.Util.UrlManager.autoRegisterModules();this.pageTemplate||this.loadPageTemplate();var b=this.page||Banana.Util.UrlManager.getModule("section")||this.settings.defaultSection;this.section=b;this.page=void 0;this.registerUrlSection(b);this.loadingWithHistory||Banana.Util.UrlManager.updateUrl();var d=this.getProxy(function(){var a=Banana.Util.NamespaceToFunction(this.settings.paths.pages+"."+b);if(!a){if(this.settings.defaultSection===b){log.error("Error default page "+this.settings.defaultSection+

...
event.target.location.hash.substring(1),b={},g,f=/\+/g,h=/([^&;=]+)=?([^&;]*)/g;g=h.exec(a);)b[decodeURIComponent(g[1].replace(f," "))]=decodeURIComponent(g[2].replace(f," "));$.each(b,function(a,b){d[a]&&void 0!=m[a]&&m[a]!==b&&jQuery(document).trigger("url."+a,[b,a]);m[a]=b})}});return{registerModule:function(a){d[a]||(d[a]={});d[a].bhmValue=f()[a]?f()[a]:""},autoRegisterModules:function(){params=f();for(param in params)param&&this.registerModule(param)},stopChecking:function(){e=!1},startChecking:function(){j()},
removeModules:function(){for(var a in d)e=!1,this.unlistenModule(a);d={}},clearUrl:function(){this.removeModules();this.removeListeners()},removeModule:function(a,b){e=!1;b?d[a].bhmValue="":(this.unlistenModule(a),delete d[a]);h();for(var g in d)return j()},setModule:function(a,b,g){if(a){if(!d[a])return!1;e=!1;d[a].bhmValue=b;!g&&(d[a]&&this.getModule[a]!=b)&&(h(),jQuery(document).trigger("url."+a,[b,a]));j()}},updateUrl:function(){h()},getModule:function(a){return d[a]&&d[a].bhmValue?d[a].bhmValue:
f()[a]?f()[a]:null},saveModuleHistory:function(){b[this.getModule("section")]=f()},getModuleHistory:function(a){return b[a]},getBrowserUrl:function(){return g()},getHistory:function(){return b},listenModule:function(b,d,g){g||(g={});e=!1;jQuery(document).bind("url."+b,g,d);a[b]=!0;j(b)},unlistenModule:function(b){jQuery(document).unbind("url."+b);delete a[b]},removeListeners:function(){for(l in a)"function"!=typeof a[l]&&this.unlistenModule(l);a=[]},getURLObject:function(){return f()},createUrlString:function(a,

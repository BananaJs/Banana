...
namespace("Banana.Controls").TabSlider=Banana.Controls.Panel.extend({init:function(){this._super();this.addCssClass("BTabSlider");this.content=[];this.activatedTab=0;this.slideSpeed=400;this.easing="swing";this.linkPreviousText=this.linkNextText="&nbsp;"},addContent:function(a,b){if(!b||"string"!=typeof b)return log.error("cannot add content without tabname");this.content.push({content:a,tabname:b});return this},setSlideSpeed:function(a){this.slideSpeed=a;return this},setEasing:function(a){this.easing=
a;return this},setUseUrlHistory:function(a){this.useUrlHistory=a;return this},setLinkNextText:function(a){this.linkNextText=a;return this},setLinkPreviousText:function(){this.linkPreviousText=text;return this},createComponents:function(){this.buttonContainer=(new Banana.Controls.Panel).addCssClass("BTabSliderButtonContainer");var a=(new Banana.Controls.Panel).addCssClass("BTabSliderContentWrapper");this.contentContainer=(new Banana.Controls.Panel).addCssClass("BTabSliderContentContainer");a.addControl(this.contentContainer);
this.addControl(this.buttonContainer);this.addControl(a);if(this.useUrlHistory&&(this.urlKey="tabSlidePos"+this.getClientId(),this.registerUrlHistory(),a=Banana.Util.UrlManager.getModule(this.urlKey)))this.activatedTab=a.substr(1)},updateDisplay:function(){this.buttonContainer.clear();this.contentContainer.clear();var a=this.getDimensions();this.contentContainer.setCss({width:a.width*this.content.length+"px"});var b=(a.width-100)/this.content.length,d=(new Banana.Controls.Panel).setCss({width:"50px"}).addCssClass("BTabSliderlinkWrapper");
this.buttonContainer.addControl(d);var e=(new Banana.Controls.Link).addCssClass("BTabSliderLink BTabSliderLinkPrevious");e.addControl(this.linkPreviousText);e.setHref("#previous tab");d.addControl(e);e.bind("click",this.getProxy(function(){this.activatedTab=this.ensureValidTab(--this.activatedTab);this.repositionPanels(this.slideSpeed);return!1}));for(d=0,e=this.content.length;d<e;d++){var f=(new Banana.Controls.Panel).setCss({width:b+"px"}).addCssClass("BTabSliderlinkWrapper");this.buttonContainer.addControl(f);
var g=(new Banana.Controls.Link).addCssClass("BTabSliderLink");g.addControl(this.content[d].tabname);g.setHref("#"+this.content[d].tabname);f.addControl(g);g.bind("click",this.getProxy(function(a){this.activatedTab=parseInt(a.data,10);this.repositionPanels(this.slideSpeed);return!1}),d.toString());f=(new Banana.Controls.Panel).addCssClass("BTabSliderContentItemContainer");f.setCss({width:a.width+"px"});f.addControl(this.content[d].content);this.contentContainer.addControl(f)}a=(new Banana.Controls.Panel).setCss({width:"50px"}).addCssClass("BTabSliderlinkWrapper");
this.buttonContainer.addControl(a);b=(new Banana.Controls.Link).addCssClass("BTabSliderLink BTabSliderLinkNext");b.addControl(this.linkNextText);b.setHref("#previous tab");a.addControl(b);b.bind("click",this.getProxy(function(){this.activatedTab=this.ensureValidTab(++this.activatedTab);this.repositionPanels(this.slideSpeed);return!1}));this.buttonContainer.invalidateDisplay();this.contentContainer.invalidateDisplay();this.repositionPanels(0)},ensureValidTab:function(a){0>a?a=this.content.length-1:
a>this.content.length-1&&(a=0);return a},registerUrlHistory:function(){Banana.Util.UrlManager.registerModule(this.urlKey);Banana.Util.UrlManager.listenModule(this.urlKey,this.getProxy(function(a,b){this.activatedTab=b;this.repositionPanels(this.slideSpeed)}))},repositionPanels:function(a){this.triggerEvent("onSlide");var b=-1*this.activatedTab*this.getDimensions().width;jQuery("#"+this.contentContainer.getClientId()).animate({left:b+"px"},{duration:a,easing:this.easing,complete:this.getProxy(function(){this.useUrlHistory&&
...
namespace("Banana").Application=Banana.Control.extend({init:function(a){log=new Banana.Util.LogManager;log.addLogger(new Banana.Util.Logger.Console);log.setLevel("error",!0);log.setLevel("warning",!0);try{jQuery(),$()}catch(b){log.error("JQuery is not found. JQuery required.")}this.settings=a;this.sectionVerticalScrollPosition={};this.id=0;a.applicationName?namespace("Banana")[a.applicationName]=this:namespace("Banana").Application=this;if(!a.pageTemplate)a.pageTemplate="PageTemplate";if(!a.paths)a.paths=
...
a,!0)}});var Application={Pages:{}};Application.Pages.PageTemplates={};Application.Pages.PageTemplates.PageTemplate={};namespace("Application.Pages.PageTemplates").PageTemplate=Banana.PageTemplate.extend({createComponents:function(){this.addControl(this.content)}});Application.Pages.Home={};
namespace("Application.Pages").Home=Banana.Page.extend({createComponents:function(){var a=new Banana.Controls.TabSlider;a.setStyle("height:300px; width:800px; border:1px solid black;border:1px solid #666666;");a.setUseUrlHistory(!0);a.activeTab=1;(new Banana.Controls.Panel).setStyle("background-color:red; height:100%; width:100%;").addControl("a");(new Banana.Controls.Panel).setStyle("background-color:blue; height:100%; width:100%;").addControl("b");var b=(new Banana.Controls.Panel).setStyle("background-color:yellow; height:100%; width:100%;");b.addControl("c");
a.addContent(this.getDg(),"Simple grid");a.addContent(this.getDg(),"Simple dataid");a.addContent(this.getDg(),"Simple datag");a.addContent(new gridFilterable,"datagrid file");a.addContent(b,"tab c");this.addControl(a);window.a=this},getDg:function(){var a=[(new Banana.Controls.DataGridColumn).setHeaderText("Id").setDataField("id"),(new Banana.Controls.DataGridColumn).setHeaderText("Name").setDataField("name"),(new Banana.Controls.DataGridColumn).setHeaderText("Description").setDataField("description"),
(new Banana.Controls.DataGridColumn).setHeaderText("Color").setDataField("color").bind("onItemCreated",this.getProxy(function(a,b){1==b.data.color?b.control.setData("red"):b.control.setData("yellow")})),(new Banana.Controls.DataGridColumn).setHeaderText("Country").setDataField("country")],b=new Banana.Controls.DataGrid;b.getListRender().setColumns(a);b.setDataSource([{id:1,name:"Orange",description:"Mare neque",country:"Peru",color:1},{id:2,name:"Apple",description:"Diam a nulla placerat ru",country:"Spain",
color:1},{id:3,name:"Banana",description:"Llis eros eget mauri",country:"Spain",color:1},{id:4,name:"Orange",description:"Morbi sollicitudin",country:"Peru",color:1},{id:5,name:"Bolwara",description:"Er in adipiscing turpis.",country:"Peru",color:1}]);return b}});
var gridFilterable=Banana.Controls.Panel.extend({createComponents:function(){this.createFilterManager();var a=new Banana.Controls.DataGrid,b=new Banana.Controls.DataGridControlPanel;a.setControlPanel(b);b.setFilters(this.filterManager.getFilters());b.setButtons([(new Banana.Controls.Button).setText("foo").bind("click",function(){console.log("click")}),(new Banana.Controls.Button).setText("bar")]);a.getListRender().setColumns(this.getColumns());this.addControl(a);this.datagrid=a;this.populateGrid()},
...
[]})).setFilterField("pageIndex")])},getDataSource:function(){var a=this.filterManager.getFilterData();newSource=this.filterDataSource("country",a,[{id:1,name:"Orange",description:"Mare neque",country:"Peru",color:1},{id:2,name:"Apple",description:"Diam a nulla placerat ru",country:"Spain",color:1},{id:3,name:"Banana",description:"Llis eros eget mauri",country:"Spain",color:1},{id:4,name:"Orange",description:"Morbi sollicitudin",country:"Peru",color:2},{id:5,name:"Bolwara",description:"Er in adipiscing turpis.",
country:"Peru",color:1},{id:6,name:"Guava",description:"Odio auctor enim",country:"Peru",color:1}]);return newSource=this.filterDataSource("color",a,newSource)},filterDataSource:function(a,b,d){var e=[];if("%"!=b[a].data)for(var f=0;f<d.length;f++)d[f][a]==b[a].data&&e.push(d[f]);else return d;return e},searchDataSource:function(){}});

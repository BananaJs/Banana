...
return e}})();Banana.Control={};namespace("Banana").Control=Class.extend({init:function(){this.generateUniqueId();this.customId=!1;this.binds=[];this.controls=[];this.debug=!1},createComponents:function(){},updateDisplay:function(){},onPreInvalidateContents:function(){},unload:function(){},onWindowResize:function(){},onVisibilityChange:function(){},onOffline:function(){},onOnline:function(){}});
Banana.Control.prototype.applyToChildren=function(a){var b=this.applyToChildren.arguments;b.shift();var d;d=0;for(len=this.controls.length;d<len;d++)a.apply(this,b)};Banana.Control.prototype.setId=function(a){this.id=a;this.customId=!0;return this};Banana.Control.prototype.getId=function(){return this.id};Banana.Control.prototype.setClientId=function(a){this.clientId=a};Banana.Control.prototype.getClientId=function(){return this.clientId};
Banana.Control.prototype.generateUniqueId=function(){this.id=Banana.Util.generateUniqueId()};Banana.Control.prototype.render=function(a,b){this.getPage().initRender(a,this,null,null,!1,b)};Banana.Control.prototype.setPage=function(a){this.page=a};Banana.Control.prototype.getPage=function(){return this.page};Banana.Control.prototype.getProxy=function(a){return jQuery.proxy(a,this)};Banana.Control.prototype.setParent=function(a){this.parent=a};Banana.Control.prototype.getParent=function(){return this.parent};
Banana.Control.prototype.getEnabled=function(){};Banana.Control.prototype.addControl=function(a){this.controls.push(a);return this};Banana.Control.prototype.addControlAt=function(a,b){this.controls.splice(b,0,a);return this};Banana.Control.prototype.getControls=function(){return this.controls};
...
Banana.Util.arrayInteratorAsync=function(a,b,d,e,f){function g(){j++;if(m>j){for(var p=0;p<=h;p++){j++;if(j>m)return e();b(a[j],j)}f&&f();var n=g;setTimeout(function(){n()},d)}else if(e)return e()}if("function"!=typeof b)return log.error("No callback specified for async iterator");var d=d||0,h=10<a.length?a.length/10:1,j=-1,m=a.length;g()};Banana.Util.ValidationManager=function(){var a=[];return{addValidator:function(b){var d;a:{i=0;for(len=a.length;i<len;i++)if(a[i].id==b.id){d=!0;break a}d=!1}d||a.push(b)},hasValidator:function(b){return-1==a.indexOf(b)?!1:!0},removeValidator:function(b){b=a.indexOf(b);a.splice(b,i)},removeValidators:function(){a=[]},validate:function(a){return a.isValid()},validateAll:function(){var b=!0;i=0;for(len=a.length;i<len;i++)a[i]&&a[i].id&&(a[i].isValid()||(b=!1));return b}}}();Banana.Util.UrlManager=function(){var a={},b={},d={},e=!1,f=function(){for(var a=location.hash.slice(1),b={},d,e,a=a.split("&"),g=a.length-1;0<=g;g--)e=a[g].split("="),d=e[0],b[d]=e.slice(1).join("=");return b},g=function(){var a="";d=Banana.Util.sortObjectKeys(d);for(var b in d)d[b].bhmValue&&(a+=0===a.length?"":"&",a=a+b+"="+d[b].bhmValue);a!=location.hash.slice(1)&&(location.hash=a)},h=function(){stopHandler=!1;e||(e=!0,$(window).bind("hashchange",function(){console.log("------\>  hash change found");
if(e){for(var a=event.target.location.hash.substring(1),b={},g,f=/\+/g,h=/([^&;=]+)=?([^&;]*)/g;g=h.exec(a);)b[decodeURIComponent(g[1].replace(f," "))]=decodeURIComponent(g[2].replace(f," "));$.each(b,function(a,b){d[a]&&d[a].bhmValue!=b&&(d[a].bhmValue=b,jQuery(document).trigger("url."+a,[b,a]))})}}))},j=function(){e=!1;$(window).unbind("hashchange")};return{registerModule:function(a){d[a]||(d[a]={});d[a].bhmValue=f()[a]?f()[a]:""},autoRegisterModules:function(){params=f();for(param in params)param&&
this.registerModule(param)},stopChecking:function(){j()},startChecking:function(){h()},removeModules:function(){for(var a in d)j(),this.unlistenModule(a);d={}},clearUrl:function(){this.removeModules();this.removeListeners()},removeModule:function(a,b){j();b?d[a].bhmValue="":(this.unlistenModule(a),delete d[a]);g();for(var e in d)return h()},setModule:function(a,b,e){if(a){e=e||!1;if(!d[a])return!1;j();d[a].bhmValue=b;!e&&(d[a]&&this.getModule[a]!=b)&&(g(),jQuery(document).trigger("url."+a,[b,a]));
h()}},updateUrl:function(){console.log("------\> update url");g()},getModule:function(a){return d[a]&&d[a].bhmValue?d[a].bhmValue:f()[a]?f()[a]:null},saveModuleHistory:function(){b[this.getModule("section")]=f()},getModuleHistory:function(a){return b[a]},getBrowserUrl:function(){return location.hash.slice(1)},getHistory:function(){return b},listenModule:function(b,d,e){e||(e={});j(b);jQuery(document).bind("url."+b,e,d);a[b]=!0;h(b)},unlistenModule:function(b){jQuery(document).unbind("url."+b);delete a[b]},
removeListeners:function(){for(l in a)"function"!=typeof a[l]&&this.unlistenModule(l);a=[]},getURLObject:function(){return f()},createUrlString:function(a,b){if(b){b.section=a;var b=Banana.Util.sortObjectKeys(b),d="",e;for(e in b)d+="&"+e+"="+b[e];return d.substr(1,d.length)}return"section="+a}}}();Banana.Util.StateManager=function(){function a(a,d,e,f,g,h){a=a+"="+escape(d)+(e?"; expires="+e.toGMTString():"")+(f?"; path="+f:"")+(g?"; domain="+g:"")+(h?"; secure":"");document.cookie=a}return{setState:function(b,d){a(b,d)},getState:function(a){a=(a=document.cookie.match("(^|;) ?"+a+"=([^;]*)(;|$)"))?unescape(a[2]):null;return"false"==a?!1:"true"==a?!0:a},removeState:function(b){a(b,"")}}}();Banana.Util.DomHelper={};
namespace("Banana.Util").DomHelper={render:function(a,b){"string"===typeof b?jQuery("#"+b).append(a):jQuery("#"+b.getClientId()).append(a)},renderBefore:function(a,b){"string"===typeof target?jQuery("#"+b).before(a):jQuery("#"+b.getClientId()).before(a)},replace:function(a,b){"string"===typeof b?jQuery(b).replaceWith(a):jQuery("#"+b.getClientId()).replaceWith(a)},renderHtml:function(a,b,d){"body"===b.getClientId()?d?jQuery("body").html(a):jQuery("body").append(a):d?jQuery("#"+b.getClientId()).html(a):
jQuery("#"+b.getClientId()).append(a)},clear:function(a){jQuery("#"+a.getClientId()).empty()},remove:function(a){"string"===typeof a?jQuery("#"+a).remove():jQuery("#"+a.getClientId()).remove()},setData:function(a,b){jQuery("#"+b.getClientId()).val(a)},setTextData:function(a,b){jQuery("#"+b.getClientId()).text(a)},setCheckBoxData:function(a,b){a?jQuery("#"+b.getClientId()).prop({checked:!0}):jQuery("#"+b.getClientId()).prop("checked",!1)},getData:function(a){return jQuery("#"+a.getClientId()).val()},
getCheckBoxData:function(a){return jQuery("#"+a.getClientId()).prop("checked")},clearIdsFrom:function(a){jQuery("#"+a+" *").attr({id:"cleared"});jQuery("#"+a).attr({id:"cleared"})}};Banana.Util.DateTimecode=function(a,b){var d=new Date;this.getTimecode=function(){return d.getTime()};this.setTimecode=function(a){d.setTime(a);return this};var e=function(a){return(10>a?"0":"")+a};this.getLocalDateTime=function(a){var a=a||"%d-%m-%Y %H:%M:%S:%F",b={H:e(d.getHours()),M:e(d.getMinutes()),S:e(d.getSeconds()),F:e(Math.round(25*(d.getMilliseconds()/1E3))),d:e(d.getDate()),m:e(d.getMonth()+1),Y:d.getFullYear(),w:d.getWeek()},f;for(f in b)a=a.replace("%"+f,b[f]);return a};this.getLocalTime=
...
unBindDataSourceControl:function(a){this.registeredDataSourceControls&&(this.controlRegisterModified=!0,delete this.registeredDataSourceControls[a.getId()])}});Banana.UiControl={};
namespace("Banana").UiControl=Banana.Control.extend({init:function(){this._super();this.css={};this.style="";this.isRendered=!1;this.enabled=this.visible=!0},addControl:function(a,b){this.isInitialized&&(b?(this.getPage().initializeControl(a,this,!1,this.controls.length+1),this.render(a)):this.getPage().initializeControl(a,this,!1,this.controls.length+1));return this._super(a)},addControlAt:function(a,b,d){if(!this.controls[b])return this.addControl(a,d);this.isInitialized&&(d?(this.getPage().initializeControl(a,
this,!1,this.controls.length+1),this.render(a,b)):this.getPage().initializeControl(a,this,!1,this.controls.length+1));return this._super(a,b)},unload:function(){cachedElement=void 0}});Banana.UiControl.prototype.getDomWriter=function(){this.cachedElement||(this.cachedElement=jQuery("#"+this.getClientId()));return this.cachedElement};Banana.UiControl.prototype.getTagName=function(){return""};
Banana.UiControl.prototype.getDimensions=function(){var a={};a.height=this.getDomWriter().height();a.width=this.getDomWriter().width();a.offset=this.getDomWriter().offset();a.position=this.getDomWriter().position();return a};Banana.UiControl.prototype.setClientId=function(a){this.clientId=a};Banana.UiControl.prototype.getClientId=function(){return this.clientId};
Banana.UiControl.prototype.triggerEvent=function(a,b){-1!==this.getDomEventTypes().indexOf(a)?this.isRendered&&this.getDomWriter().trigger(a,b):jQuery(this).trigger(a,b)};Banana.UiControl.prototype.setState=function(a,b){var d=Banana.Util.UrlManager.getModule("section"),e=this.getClientId();this.customId&&(e=this.getId());Banana.Util.StateManager.setState(d+"-"+e+"-"+a,b);return this};
...
Banana.UiControl.prototype.getAttributes=function(){var a={};this.attributes&&(a=this.attributes);a.id=this.getClientId();a.style=this.getStyle();if(this.getCss()){var b=[],d;for(d in this.getCss())cssPart=d+":"+this.getCss()[d]+";",b.push(cssPart);a.style+=b.join("")}0<this.getCssClass().length&&(a["class"]=this.getCssClass().join(" "));return a};
Banana.UiControl.prototype.setAttribute=function(a,b){if(this.isRendered)switch(a){case "async":case "autofocus":case "checked":case "location":case "multiple":case "readOnly":case "selected":case "autoplay":case "controls":case "defer":case "disabled":case "hidden":case "loop":case "open":case "scoped":this.getDomWriter().prop(a,b);break;default:this.getDomWriter().attr(a,b)}var d=this.getAttributes();d[a]=b;this.attributes=d;return this};
Banana.UiControl.prototype.removeAttribute=function(a){if(this.isRendered)switch(a){case "async":case "autofocus":case "checked":case "location":case "multiple":case "readOnly":case "selected":case "autoplay":case "controls":case "defer":case "disabled":case "hidden":case "loop":case "open":case "scoped":this.getDomWriter().removeProp(a);break;default:this.getDomWriter().attr(a,"")}this.attributes&&this.attributes[a]&&delete this.attributes[a];return this};
Banana.UiControl.prototype.getAttribute=function(a){return!this.attributes?null:this.attributes[a]};Banana.UiControl.prototype.setStyle=function(a){this.style=a;return this};Banana.UiControl.prototype.getStyle=function(){return this.style};Banana.UiControl.prototype.addCss=function(a){var b={},d;for(d in this.getCss())b[d]=this.getCss()[d];for(d in a)b[d]=a[d];this.css=b};Banana.UiControl.prototype.setCss=function(a){this.addCss(a);this.isRendered&&this.getDomWriter().css(this.css);return this};
Banana.UiControl.prototype.getCss=function(){return this.css};Banana.UiControl.prototype.getStyleProperty=function(a){return this.css[a]||this.getDomWriter().css(a)};Banana.UiControl.prototype.getCssClass=function(){this.cssClass||(this.cssClass=[]);return this.cssClass};Banana.UiControl.prototype.addCssClass=function(a){this.cssClass||(this.cssClass=[]);this.hasCssClass(a)||(this.cssClass.push(a),this.isRendered&&this.getDomWriter().addClass(a));return this};
Banana.UiControl.prototype.removeCssClass=function(a){if(!this.cssClass)return this;var b=this.cssClass.indexOf(a);-1!=b&&(this.cssClass.splice(b,1),this.isRendered&&this.getDomWriter().removeClass(a));return this};Banana.UiControl.prototype.switchCssClass=function(a,b){this.removeCssClass(a);this.addCssClass(b);return this};Banana.UiControl.prototype.hasCssClass=function(a){return this.isRendered?this.getDomWriter().hasClass(a):0<=jQuery.inArray(a,this.getCssClass())?!0:!1};
Banana.UiControl.prototype.getHtmlAttributes=function(){var a=this.getAttributes(),b="",d;for(d in a)a[d]&&"undefined"!=a[d]&&(b+=d+'="'+a[d]+'" ');return b};
...
this.getDomWriter().hide(b,this.getProxy(function(){this.setCss({display:"none"});e&&e()}))),f||this.setCss({display:"none"}));return this};Banana.UiControl.prototype.getVisible=function(){return this.isRendered?this.getDomWriter().is(":visible"):this.visible};
Banana.UiControl.prototype.registerEvents=function(){if(this.binds||this.binds.length){var a,b;a=0;for(b=this.binds.length;a<b;a++){var d=this.binds[a].name,e=this.binds[a].func,f=this.binds[a].data,g=this.binds[a].type;g===Banana.Controls.EventTypes.DOM_EVENT?(this.debugEvent(g,d,"Register event"),f?this.getDomWriter().bind(d,f,e):this.getDomWriter().bind(d,e)):g===Banana.Controls.EventTypes.CUSTOM_EVENT&&this.getPage().isRerendering&&(f?jQuery(this).bind(d,f,e):jQuery(this).bind(d,e))}}};
Banana.UiControl.prototype.unregisterEvents=function(){this.binds&&this.binds.length&&(this.debugEvent(3,name,"Unregister all event"),this.getDomWriter().unbind(),jQuery(this).unbind())};
Banana.UiControl.prototype.setEnabled=function(a,b){this.triggerEvent("onSetEnabled",a);a?(this.enabled=!0,this.isRendered&&this.getDomWriter().prop("disabled",!1)):(this.enabled=!1,this.isRendered&&this.getDomWriter().prop("disabled",!0));if(b){var d=this.getControls(),e,f;e=0;for(f=d.length;e<f;e++)d[e].setEnabled&&d[e].setEnabled(a,b)}return this};Banana.UiControl.prototype.getEnabled=function(){return this.enabled};
Banana.UiControl.prototype.getHtml=function(a){this.cachedElement=void 0;var b;b=""+("<"+this.getTagName()+" ");b+=this.getHtmlAttributes();b+=">";var d=this.getControls(),e,f;e=0;for(f=d.length;e<f;e++)d[e]instanceof Banana.Control?b+=d[e].getHtml(a,!0):"string"===typeof d[e]&&(b+=d[e]);this instanceof Banana.UiControl&&(b+="</"+this.getTagName()+">");a&&(this.isRendered=!0);return b};Banana.Controls={};Banana.Controls.Panel={};namespace("Banana.Controls").Panel=Banana.UiControl.extend({init:function(){this._super()}});Banana.Controls.Panel.prototype.getTagName=function(){return"div"};Banana.Page={};
namespace("Banana").Page=Banana.Controls.Panel.extend({init:function(){this.triggerEvent("onInit");this.addCssClass("BPage");this._super();this.uniqueId=0;this.validators=[];this.dataSets=[];this.resizefunc||(this.resizefunc=this.getProxy(function(){this.onWindowResize(this)}));window.addEventListener("resize",this.resizefunc);this.visibilityChangeFunc||(this.visibilityChangeFunc=this.getProxy(function(){this.onVisibilityChange(this)}));document.addEventListener("visibilitychange",this.visibilityChangeFunc);
this.offlineFunc||(this.offlineFunc=this.getProxy(function(){this.onOffline(this)}));addEventListener("offline",this.offlineFunc);this.onlineFunc||(this.onlineFunc=this.getProxy(function(){this.onOnline(this)}));addEventListener("online",this.onlineFunc)}});Banana.Page.prototype.setApplication=function(a){this.application=a};Banana.Page.prototype.getApplication=function(){return this.application};Banana.Page.prototype.run=function(a){this.validationControls={};this.initRender(this,a||this.getApplication().settings.renderTarget)};
Banana.Page.prototype.initRender=function(a,b,d,e,f,g){this.rendering=!0;e?(this.renderControl(a,b,d,g),this.rendering=!1,this.recursiveRegisterEvents(a)):(this.isRendered=!1,this.initializeControl(a,b),this.renderControl(a,b,d,g),this.isRendered=!0,this.setVisible(!0),a&&a.triggerEvent&&a.triggerEvent("renderComplete",this),f||(this.recursiveRegisterEvents(a),this.parentFirstTimeRendering=this.rendering=!1),this.recursiveUpdateDisplay(a))};
...
Banana.Page.prototype.initializeControl=function(a,b){if(a instanceof Banana.Control){if(b instanceof Banana.Control)a.clientId||a.setClientId("b"+ ++window.domuuid);else{var d=this.getApplication().settings.applicationName;d?a.setClientId(d+this.uniqueId++):a.setClientId(this.uniqueId++)}a.setParent(b);a.setPage(this);a.isInitialized||(a.createComponents(),a.isInitialized=!0,(d=a.bindedDataSource)&&this.getDataSet(d[0])&&this.getDataSet(d[0]).bindControlToDataSource(a),(d=a.bindedData)&&this.getDataSet(d[0])&&
this.getDataSet(d[0]).bindControlToData(a));var d=a.getControls(),e,f;e=0;for(f=d.length;e<f;e++)this.initializeControl(d[e],a)}};
Banana.Page.prototype.renderControl=function(a,b,d,e){a.cachedElement=void 0;b.cachedElement=void 0;a=a instanceof Banana.Control?a.getHtml(!0):a;void 0!=e?b.controls[e]?Banana.Util.DomHelper.renderBefore(a,b.controls[e]):(console.error("cannot add control at this index ",e),Banana.Util.DomHelper.render(a,b)):d?Banana.Util.DomHelper.replace(a,d):Banana.Util.DomHelper.render(a,b)};
Banana.Page.prototype.recursiveUpdateDisplay=function(a){if(a instanceof Banana.Control){a.isRendered=!0;a.updateDisplay();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.recursiveUpdateDisplay(a[b])}};Banana.Page.prototype.recursiveRegisterEvents=function(a){if(a instanceof Banana.Control){a.registerEvents();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.recursiveRegisterEvents(a[b])}};
Banana.Page.prototype.recursiveUnRegisterEvents=function(a){if(a instanceof Banana.Control&&(a.onPreInvalidateContents(),a.unregisterEvents(),a instanceof Banana.Control)){var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.recursiveUnRegisterEvents(a[b])}};
Banana.Page.prototype.removeControl=function(a,b){if(a instanceof Banana.Control){var d=a.controls.slice(),e;for(e=d.length-1;0<=e;e--)this.removeControl(d[e],!0),d.pop();a.unregisterEvents();a.unload();b||Banana.Util.DomHelper.remove(a);if(d=a.parent)e=d.controls.indexOf(a),d.controls.splice(e,1)}};
Banana.Page.prototype.clearControl=function(a){var b=a.getControls().slice(),d=0,e,f;e=0;for(f=b.length;e<f;e++)d++,this.removeControl(b[e],!0);a.controls=null;a.cachedElement?a.cachedElement.empty():jQuery("#"+a.getClientId()).empty()};
Banana.Page.prototype.remove=function(a,b){var d=Banana.Util.flattenTreeDepthFirst(this,"controls");d.pop();Banana.Util.arrayInteratorAsync(d,this.getProxy(function(a){if(a instanceof Banana.Control){a.unregisterEvents();a.unload();var b=a.parent;b&&b.controls&&b.controls.splice(b.controls.indexOf(a),1)}}),0,this.getProxy(function(){this.unload();Banana.Util.ValidationManager.removeValidators();this.clearIds();window.removeEventListener("resize",this.resizefunc);document.removeEventListener("visibilitychange",
this.visibilityChangeFunc);removeEventListener("online",this.onlineFunc);removeEventListener("offline",this.offlineFunc);this.unbind();this.removeDataSets();clearTimeout(this.timer);a||Banana.Util.DomHelper.remove(this);jQuery("#debug").remove();clearTimeout(this.debugTimer);b&&b()}),this.getProxy(function(){}))};Banana.Page.prototype.removeDom=function(){jQuery("#cleared").remove()};Banana.Page.prototype.clearProps=function(){};
Banana.Page.prototype.onWindowResize=function(a){if(a instanceof Banana.Control){a.onWindowResize();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.onWindowResize(a[b])}};Banana.Page.prototype.onVisibilityChange=function(a){if(a instanceof Banana.Control){a.onVisibilityChange();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.onVisibilityChange(a[b])}};
Banana.Page.prototype.onOffline=function(a){if(a instanceof Banana.Control){a.onOffline();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.onOffline(a[b])}};Banana.Page.prototype.onOnline=function(a){if(a instanceof Banana.Control){a.onOnline();var a=a.getControls(),b,d;b=0;for(d=a.length;b<d;b++)this.onOnline(a[b])}};Banana.Page.prototype.clearIds=function(a){a||(a=this);Banana.Util.DomHelper.clearIdsFrom(a.getClientId())};Banana.PageTemplate={};
...
!0)}));this.bind("dataSourceChanged",this.getProxy(function(){null==this.data&&(this.data=0);null!=this.data&&(this.createPageLinks(),this.createDropDownDataSource());this.triggerEvent("filterDataSourceChanged")}));this.bind("indexChanged",this.getProxy(function(){this.createDropDownDataSource();this.triggerEvent("filterDataChanged")}))}});Banana.Controls.DataGridPagerFilter.prototype.getAllKey=function(){return null};
...
namespace("Banana.Controls").VBox=Banana.Controls.Panel.extend({init:function(){this._super();this.spacing=0},setSpacing:function(a){this.spacing=a;return this},updateDisplay:function(){this._super();for(var a=0,b=this.controls.length;a<b;a++){var d=this.controls[a];d instanceof Banana.Control&&("none"==d.getStyleProperty("float")?d.setCss({clear:"both","float":"",width:"100%"}):d.setCss({clear:"both","float":""}),a<this.controls.length&&d.setCss({"margin-bottom":this.spacing+"px"}))}}});window.domuuid=0;namespace("Banana.Controls").EventTypes={DOM_EVENT:1,CUSTOM_EVENT:2};
namespace("Banana").Application=Banana.Control.extend({init:function(a){log=new Banana.Util.LogManager;log.addLogger(new Banana.Util.Logger.Console);log.setLevel("error",!0);log.setLevel("warning",!0);try{jQuery()}catch(b){log.error("JQuery is not found. JQuery required.");return}a||(a={});this.settings=a;this.sectionVerticalScrollPosition={};this.id=0;a.applicationName?namespace("Banana")[a.applicationName]=this:namespace("Banana").Application=this;a.pageTemplate||(a.pageTemplate="PageTemplate");
a.paths||(a.paths={});a.paths.pages||(a.paths.pages="Application.Pages");setTimeout(this.getProxy(function(){this.prepareUnload()}),200)},prepareUnload:function(){jQuery(window).on("beforeunload",this.getProxy(function(){jQuery("*").unbind();this.activePage&&this.activePage.remove();this.pageTemplate&&this.pageTemplate.remove();delete Banana}))},loadPageTemplate:function(){if(this.settings.paths.pageTemplates)var a=this.settings.paths.pageTemplates+"."+this.settings.pageTemplate,b=Banana.Util.NamespaceToFunction(a);
else b=Banana.PageTemplate;if(b)try{this.pageTemplate=new b}catch(d){log.error("Error: could not instantiate template: "+a)}else log.error("Error: could not find Template: "+a)},getSettings:function(){return this.settings},setSectionVerticalScrollPosition:function(a){this.sectionVerticalScrollPosition[a]=window.scrollY},getSectionVerticalScrollPosition:function(a){return this.sectionVerticalScrollPosition[a]},loadPage:function(a,b,d,e){Banana.Util.UrlManager.saveModuleHistory("section");this.setSectionVerticalScrollPosition(this.section);
Banana.Util.UrlManager.clearUrl();if(this.loadingWithHistory=!d){var f=Banana.Util.UrlManager.getModuleHistory(a),g;for(g in f)f.hasOwnProperty(g)&&(Banana.Util.UrlManager.registerModule(g),Banana.Util.UrlManager.setModule(g,f[g],!0))}if(b)for(var h in b)b.hasOwnProperty(h)&&(Banana.Util.UrlManager.registerModule(h),Banana.Util.UrlManager.setModule(h,b[h],!0));this.run(a,e);d||window.scrollTo(0,this.getSectionVerticalScrollPosition(a)||0)},instantiateSinglePage:function(){this.pageTemplate||this.loadPageTemplate();
this.page.bind("renderComplete",this.getProxy(function(){this.activePage&&(this.activePage.removeDom(),this.activePage.clearProps(),this.activePage=void 0);this.activePage=this.page;this.activePage.setVisible(!0)}));this.page.setVisible(!1);this.pageTemplate.addPageControl(this.page);this.pageTemplate.setApplication(this);this.pageTemplate.run(this)},run:function(a,b){a&&(this.page=a);if(a instanceof Banana.Page)return this.instantiateSinglePage();this.triggerEvent("onPreLoadPage");this.activePage||
Banana.Util.UrlManager.autoRegisterModules();this.pageTemplate||this.loadPageTemplate();var d=this.page||Banana.Util.UrlManager.getModule("section")||this.settings.defaultSection;this.section=d;this.page=void 0;this.registerUrlSection(d);this.loadingWithHistory||Banana.Util.UrlManager.updateUrl();var e=this.getProxy(function(){var a=Banana.Util.NamespaceToFunction(this.settings.paths.pages+"."+d);if(!a){if(this.settings.defaultSection===d){log.error("Error default page "+this.settings.defaultSection+
" cannot be loaded");return}log.error("Page "+d+" not found. Load default page "+this.settings.defaultSection);return this.loadPage(this.settings.defaultSection)}this.id++;var e=new a;e.bind("renderComplete",this.getProxy(function(){this.activePage&&(this.activePage.removeDom(),this.activePage.clearProps(),this.activePage=void 0);this.activePage=e;this.activePage.setVisible(!0)}));e.setVisible(!1);this.pageTemplate.addPageControl(e);this.pageTemplate.setApplication(this);Banana.Util.UrlManager.updateUrl();
this.pageTemplate.run();b&&b()});this.activePage?(Banana.Util.UrlManager.stopChecking(),this.activePage.remove(!0,this.getProxy(function(){Banana.Util.UrlManager.startChecking();e();Banana.Util.UrlManager.listenModule("section",this.getProxy(function(){this.loadPage(Banana.Util.UrlManager.getModule("section"))}))}))):(e(),Banana.Util.UrlManager.listenModule("section",this.getProxy(function(){this.loadPage(Banana.Util.UrlManager.getModule("section"))})))},registerUrlSection:function(a){Banana.Util.UrlManager.registerModule("section",
a);Banana.Util.UrlManager.setModule("section",a,!0)}});Banana.App=Banana.Application;var Application={Pages:{}};Application.Pages.PageTemplates={};Application.Pages.PageTemplates.PageTemplate={};namespace("Application.Pages.PageTemplates").PageTemplate=Banana.PageTemplate.extend({createComponents:function(){this.addControl(this.content)}});Application.Pages.Home={};namespace("Application.Pages").Home=Banana.Page.extend({init:function(){this._super()},createComponents:function(){this.addControl("Banana works")},updateDisplay:function(){}});

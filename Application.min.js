...
Banana.Util.arrayInteratorAsync=function(a,b,d,e,f){function g(){k++;if(j>k){for(var n=0;n<=h;n++){k++;if(k>j)return e();b(a[k],k)}f&&f();var m=g;setTimeout(function(){m()},d)}else if(e)return e()}if("function"!=typeof b)return log.error("No callback specified for async iterator");var d=d||0,h=10<a.length?a.length/10:1,k=-1,j=a.length;g()};Banana.Util.ValidationManager=function(){var a=[];return{addValidator:function(b){var d;a:{i=0;for(len=a.length;i<len;i++)if(a[i].id==b.id){d=!0;break a}d=!1}d||a.push(b)},hasValidator:function(b){return-1==a.indexOf(b)?!1:!0},removeValidator:function(b){b=a.indexOf(b);a.splice(b,i)},removeValidators:function(){a=[]},validate:function(a){return a.isValid()},validateAll:function(){var b=!0;i=0;for(len=a.length;i<len;i++)a[i]&&a[i].id&&(a[i].isValid()||(b=!1));return b}}}();Banana.Util.UrlManager=function(){var a={},b={},d={},e=null,f=null,g=!1,h=function(){for(var a=k(),b={},d,e,a=a.split("&"),f=a.length-1;0<=f;f--)e=a[f].split("="),d=e[0],b[d]=e.slice(1).join("=");return b},k=function(){return"Microsoft Internet Explorer"==navigator.appName&&document.getElementById("URLFrame")?(location.hash=document.frames.URLFrame.location.search.slice(1),document.frames.URLFrame.location.search.slice(1)):location.hash.slice(1)},j=function(){var a="";d=Banana.Util.sortObjectKeys(d);
for(var b in d)d[b].bhmValue&&(a+=0===a.length?"":"&",a=a+b+"="+d[b].bhmValue);a!=k()&&("Microsoft Internet Explorer"==navigator.appName&&document.getElementById("URLFrame")&&(document.frames.URLFrame.location.replace(document.frames.URLFrame.location.pathname+"?"+location.hash.slice(1)),document.getElementById("URLFrame").setAttribute("src",document.frames.URLFrame.location.pathname+"?"+a)),location.hash=a)},n=function(){stopHandler=!1;g||m()},m=function(){g=!0;stopHandler?(clearTimeout(f),stopHandler=
!1):(e||(e=function(){var a=h(),b,e;for(e in d)b=a[e]||"",d[e]&&a[e]&&d[e].bhmValue!=b&&(d[e].bhmValue=b,jQuery(document).trigger("url."+e,[b,e]));m()}),f=setTimeout(e,20))},r=function(){stopHandler=!0;clearTimeout(f);f=null;g=!1};return{registerModule:function(a){d[a]||(d[a]={});d[a].bhmValue=h()[a]?h()[a]:""},autoRegisterModules:function(){params=h();for(param in params)param&&this.registerModule(param)},stopChecking:function(){r()},startChecking:function(){n()},removeModules:function(){for(var a in d)r(),
this.unlistenModule(a);d={}},clearUrl:function(){this.removeModules();this.removeListeners()},removeModule:function(a,b){r();b?d[a].bhmValue="":(this.unlistenModule(a),delete d[a]);j();for(var e in d)return n()},setModule:function(a,b,e){if(a){e=e||!1;if(!d[a])return!1;r();d[a].bhmValue=b;!e&&(d[a]&&this.getModule[a]!=b)&&(j(),jQuery(document).trigger("url."+a,[b,a]));n()}},updateUrl:function(){j()},getModule:function(a){return d[a]&&d[a].bhmValue?d[a].bhmValue:h()[a]?h()[a]:null},saveModuleHistory:function(){b[this.getModule("section")]=
h()},getModuleHistory:function(a){return b[a]},getBrowserUrl:function(){return k()},getHistory:function(){return b},listenModule:function(b,d,e){e||(e={});r(b);jQuery(document).bind("url."+b,e,d);a[b]=!0;n(b)},unlistenModule:function(b){jQuery(document).unbind("url."+b);delete a[b]},removeListeners:function(){for(l in a)"function"!=typeof a[l]&&this.unlistenModule(l);a=[]},getURLObject:function(){return h()},createUrlString:function(a,b){if(b){b.section=a;var b=Banana.Util.sortObjectKeys(b),d="",
e;for(e in b)d+="&"+e+"="+b[e];return d.substr(1,d.length)}return"section="+a}}}();Banana.Util.StateManager=function(){function a(a,d,e,f,g,h){a=a+"="+escape(d)+(e?"; expires="+e.toGMTString():"")+(f?"; path="+f:"")+(g?"; domain="+g:"")+(h?"; secure":"");document.cookie=a}return{setState:function(b,d){a(b,d)},getState:function(a){a=(a=document.cookie.match("(^|;) ?"+a+"=([^;]*)(;|$)"))?unescape(a[2]):null;return"false"==a?!1:"true"==a?!0:a},removeState:function(b){a(b,"")}}}();Banana.Util.DomHelper={};
...
h=[],j=e.length,n=null,m=e.length;a.each(e.split(""),function(a,b){"?"==b?(m--,j=a):k[b]?(h.push(RegExp(k[b])),null==n&&(n=h.length-1)):h.push(null)});return this.each(function(){function g(a){for(;++a<=m&&!h[a];)return a}function v(b){var e=a(this).caret(),b=b.keyCode;u=16>b||16<b&&32>b||32<b&&41>b;0!=e.begin-e.end&&(!u||8==b||46==b)&&x(e.begin,e.end);if(8==b||46==b||d&&127==b){for(e=e.begin+(46==b?0:-1);!h[e]&&0<=--e;){for(b=e;b<m;b++)if(h[b]){q[b]=f.placeholder;var j=g(b);if(j<m&&h[b].test(q[j]))q[b]=
q[j];else break}t();p.caret(Math.max(n,e))}return!1}if(27==b)return p.val(w),p.caret(0,s()),!1}function y(b){if(u)return u=!1,8==b.keyCode?!1:null;var b=b||window.event,d=b.charCode||b.keyCode||b.which,e=a(this).caret();if(b.ctrlKey||b.altKey||b.metaKey)return!0;if(32<=d&&125>=d||186<d)if(b=g(e.begin-1),b<m&&(d=String.fromCharCode(d),h[b].test(d))){for(var e=b,j=f.placeholder;e<m;e++)if(h[e]){var k=g(e),n=q[e];q[e]=j;if(k<m&&h[k].test(n))j=n;else break}q[b]=d;t();b=g(b);a(this).caret(b);f.completed&&
b==m&&f.completed.call(p)}return!1}function x(a,b){for(var d=a;d<b&&d<m;d++)h[d]&&(q[d]=f.placeholder)}function t(){return p.val(q.join("")).val()}function s(a){for(var b=p.val(),d=-1,e=0,g=0;e<m;e++)if(h[e]){for(q[e]=f.placeholder;g++<b.length;){var k=b.charAt(g-1);if(h[e].test(k)){q[e]=k;d=e;break}}if(g>b.length)break}else q[e]==b[g]&&e!=j&&(g++,d=e);if(!a&&d+1<j)p.val(""),x(0,m);else if(a||d+1>=j)t(),a||p.val(p.val().substring(0,d+1));return j?e:n}var p=a(this),q=a.map(e.split(""),function(a){if("?"!=
a)return k[a]?f.placeholder:a}),u=!1,w=p.val();p.data("buffer",q).data("tests",h);p.attr("readonly")||p.one("unmask",function(){p.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){w=p.val();var a=s();t();setTimeout(function(){a==e.length?p.caret(0,a):p.caret(a)},0)}).bind("blur.mask",function(){s();p.val()!=w&&p.change()}).bind("keydown.mask",v).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){p.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.DataControls.RadioButton={};namespace("Banana.Controls").RadioButton=Banana.Controls.InputControl.extend({init:function(){this._super();this.setAttribute("type","radio");this.addCssClass("BRadioButton")},setName:function(a){this.setAttribute("name",a);return this},setDomData:function(a){this.isRendered&&Banana.Util.DomHelper.setCheckBoxData(a,this);return this},getDomData:function(){if(this.isRendered)return Banana.Util.DomHelper.getCheckBoxData(this)}});Banana.Controls.DataControls.ProgressBar={};
...
q[j];else break}t();p.caret(Math.max(n,e));return!1}if(27==b)return p.val(w),p.caret(0,s()),!1}function y(b){if(u)return u=!1,8==b.keyCode?!1:null;var b=b||window.event,d=b.charCode||b.keyCode||b.which,e=a(this).caret();if(b.ctrlKey||b.altKey||b.metaKey)return!0;if(32<=d&&125>=d||186<d)if(b=g(e.begin-1),b<m&&(d=String.fromCharCode(d),h[b].test(d))){for(var e=b,j=f.placeholder;e<m;e++)if(h[e]){var k=g(e),n=q[e];q[e]=j;if(k<m&&h[k].test(n))j=n;else break}q[b]=d;t();b=g(b);a(this).caret(b);f.completed&&
b==m&&f.completed.call(p)}return!1}function x(a,b){for(var d=a;d<b&&d<m;d++)h[d]&&(q[d]=f.placeholder)}function t(){return p.val(q.join("")).val()}function s(a){for(var b=p.val(),d=-1,e=0,g=0;e<m;e++)if(h[e]){for(q[e]=f.placeholder;g++<b.length;){var k=b.charAt(g-1);if(h[e].test(k)){q[e]=k;d=e;break}}if(g>b.length)break}else q[e]==b[g]&&e!=j&&(g++,d=e);if(!a&&d+1<j)p.val(""),x(0,m);else if(a||d+1>=j)t(),a||p.val(p.val().substring(0,d+1));return j?e:n}var p=a(this),q=a.map(e.split(""),function(a){if("?"!=
a)return k[a]?f.placeholder:a}),u=!1,w=p.val();p.data("buffer",q).data("tests",h);p.attr("readonly")||p.one("unmask",function(){p.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){w=p.val();var a=s();t();setTimeout(function(){a==e.length?p.caret(0,a):p.caret(a)},0)}).bind("blur.mask",function(){s();p.val()!=w&&p.change()}).bind("keydown.mask",v).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){p.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.SwitchButton={};

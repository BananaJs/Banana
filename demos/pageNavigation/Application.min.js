...
a,!0)}});var Application={Pages:{}};Application.Pages.MyPage1={};namespace("Application.Pages").MyPage1=Banana.Page.extend({createComponents:function(){this.setCss({"background-color":"blue"});var a=new Banana.Controls.Button;a.setText("Go to page 2");a.bind("click",function(){Banana.Application.loadPage("MyPage2")});this.addControl(a)}});Application.Pages.MyPage2={};namespace("Application.Pages").MyPage2=Banana.Page.extend({createComponents:function(){this.setCss({"background-color":"red"});var a=new Banana.Controls.Button;a.setText("Go to page 1");a.bind("click",function(){Banana.Application.loadPage("MyPage1")});this.addControl(a)}});

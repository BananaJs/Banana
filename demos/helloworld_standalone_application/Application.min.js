...
namespace("Banana").Application=Banana.Control.extend({init:function(a){log=new Banana.Util.LogManager;log.addLogger(new Banana.Util.Logger.Console);log.setLevel("error",!0);log.setLevel("warning",!0);try{jQuery(),$()}catch(b){log.error("JQuery is not found. JQuery required.")}this.settings=a;this.sectionVerticalScrollPosition={};this.id=0;a.applicationName?namespace("Banana")[a.applicationName]=this:namespace("Banana").Application=this;a.pageTemplate||(a.pageTemplate="PageTemplate");a.paths||(a.paths=
{});a.paths.pages||(a.paths.pages="Application.Pages");this.prepareUnload()},prepareUnload:function(){jQuery(window).unload(this.getProxy(function(){jQuery("*").unbind();this.activePage&&this.activePage.remove();this.pageTemplate&&this.pageTemplate.remove();Banana=null}))},loadPageTemplate:function(){if(this.settings.paths.pageTemplates)var a=this.settings.paths.pageTemplates+"."+this.settings.pageTemplate,b=Banana.Util.NamespaceToFunction(a);else b=Banana.PageTemplate;if(b)try{this.pageTemplate=

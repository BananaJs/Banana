...
d.clientId).siblings().css({opacity:1});d.remove();a.disableClicks=!1}})})});d.addControl(e);this.getListRender().controls[0].addControl(d,!0);jQuery("#"+d.clientId).siblings().css({opacity:0.8});jQuery("#"+d.clientId).animate({width:"100%",height:"100%",left:0,top:0},{duration:300,easing:"swing",complete:this.getProxy(function(){e.onGrown();a.disableClicks=!1})})},updateDisplay:function(){this.panel.setCss({height:Math.round(0.7*this.panel.getDimensions().width)})},select:function(){this.panel.addCssClass("ExampleTileSimple2ItemRenderSelected")},
deselect:function(){this.panel.removeCssClass("ExampleTileSimple2ItemRenderSelected")},getIsSelectable:function(){return!1}});Application.Controls.Datagrids={};Application.Controls.Datagrids.TablegridSimple={};
...
0;f<d.length;f++)d[f][a]==b[a].data&&e.push(d[f]);else return d;return e},searchDataSource:function(){}});Application.Pages.MyPage={};
...
var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Table datagrid",control:"Application.Controls.Datagrids.TablegridSimple",contents:"Table datagrid shows a vertical list of items devided in rows and columns."},{title:"Filterable",control:"Application.Controls.Datagrids.TablegridFilterable",contents:"Table datagrid with filterable components"},
{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Dynamic data coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Dynamic updating the contents of the list"}]);return grid},getTileGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTileDataGrids");
var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Tile datagrid",link:"ewrwe",contents:"Tile datagrid in a simple form"},{title:"Selectables",link:"ewrwe",contents:"Selectable tiles"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",

...
Banana.Controls.DataGridButtonColumn.prototype.getControl=function(){var a=new Banana.Controls.Button;a.setText(this.buttonText);a.bind("click",this.getProxy(function(b){function d(a){return a instanceof Banana.Controls.DataGridTableItemRender?a:d(a.getParent())}var e=this.listRender.getIndexByItemRender(d(a));b.stopPropagation();this.listRender.triggerEvent("onCommand",{commandName:this.commandName,index:e,data:this.listRender.datasource[e]})}));return a};
...
d);d.bind("mouseout",this.getProxy(function(a){this.onRowMouseOut(a)}),d);d.bind("click",this.getProxy(function(a){this.onRowMouseClick(a)}),d);this.tableBody.addControl(d,b);b&&this.tableBody.invalidateDisplay();this.indexRowMap[a]=d;this.triggerEvent("onRowCreated",{row:d,data:this.datasource[a]})},createItemRenderByIndex:function(a,b){this.currentIndexCreation=a;var d=null,d=this.datasource[a][this.indexKey]&&this.dataItemRenderMap.getItem(this.datasource[a][this.indexKey])?this.dataItemRenderMap.getItem(this.datasource[a][this.indexKey]):
...
void 0},onRowMouseOver:function(a){a=this.indexRenderedItemRenderMap[this.indexRowMap.indexOf(a.data)];a.getIsSelectable()&&a.mouseOver()},onRowMouseOut:function(a){a=this.indexRenderedItemRenderMap[this.indexRowMap.indexOf(a.data)];a.getIsSelectable()&&a.mouseOut()},onRowMouseClick:function(a){var b=this.indexRowMap.indexOf(a.data);if(this.indexRenderedItemRenderMap[b].getIsSelectable()&&!(0>b)){var d=a.ctrlKey,a=a.shiftKey;if(this.getIndexIsSelected(b))!d&&!a?this.clearSelectedIndices():this.clearSelectedIndex(b);
else if("single"==this.selectionType)this.clearSelectedIndices(),this.addSelectedIndex(b);else if(!d&&!a&&(this.clearSelectedIndices(),this.addSelectedIndex(b)),d&&this.addSelectedIndex(b),a){(d=parseInt(this.selectedIndices.getKeyByIndex(0)))||(d=0);b>d||(d=b,b=parseInt(this.selectedIndices.getKeyByIndex([this.selectedIndices.getLength()-1])));this.clearSelectedIndices();for(d=parseInt(d);d<=parseInt(b);d++)this.addSelectedIndex(d)}this.triggerEvent("onItemSelect")}},selectIndex:function(a){(a=this.getRenderedItemRenderByIndex(a))&&
"function"==typeof a.select&&a.getIsSelectable()&&a.select()},deSelectIndex:function(a){(a=this.getRenderedItemRenderByIndex(a))&&"function"==typeof a.deselect&&a.deselect()}});Banana.Controls.DataGridTileItemRender={};
...
this.getProxy(function(){this.onSetData();this.dropDown.setData(this.getData());this.createDropDownDataSource();null!=this.datasource&&this.createPageLinks();this.triggerEvent("filterDataChanged",!0)}));this.bind("dataSourceChanged",this.getProxy(function(){if(null==this.data)this.data=0;null!=this.data&&(this.createPageLinks(),this.createDropDownDataSource());this.triggerEvent("filterDataSourceChanged")}));this.bind("indexChanged",this.getProxy(function(){this.createDropDownDataSource();this.triggerEvent("filterDataChanged")}))}});
...
namespace("Banana.Controls").TabSlider=Banana.Controls.Panel.extend({init:function(){this._super();this.addCssClass("BTabSlider");this.content=[];this.activatedTab=0;this.slideSpeed=400;this.easing="swing";this.useUrlHistory=this.useAutoHeight=!1;this.linkPreviousText=this.linkNextText="&nbsp;"},onWindowResize:function(){this.repositionPanels()},addContent:function(a,b){if(!b||"string"!=typeof b)return log.error("cannot add content without tabname");this.content.push({content:a,tabname:b});return this},
setSlideSpeed:function(a){this.slideSpeed=a;return this},setUseAutoHeight:function(a){this.useAutoHeight=a;return this},setEasing:function(a){this.easing=a;return this},setUseUrlHistory:function(a){this.useUrlHistory=a;return this},setLinkNextText:function(a){this.linkNextText=a;return this},setLinkPreviousText:function(){this.linkPreviousText=text;return this},createComponents:function(){this.buttonContainer=(new Banana.Controls.Panel).addCssClass("BTabSliderButtonContainer");var a=(new Banana.Controls.Panel).addCssClass("BTabSliderContentWrapper");
this.contentContainer=(new Banana.Controls.Panel).addCssClass("BTabSliderContentContainer");a.addControl(this.contentContainer);this.addControl(this.buttonContainer);this.addControl(a);if(this.useUrlHistory&&(this.urlKey="tabSlidePos"+this.getClientId(),this.registerUrlHistory(),a=Banana.Util.UrlManager.getModule(this.urlKey)))this.activatedTab=a},updateDisplay:function(){this.buttonContainer.clear();this.contentContainer.clear();var a=this.getDimensions();this.contentContainer.setCss({width:a.width*
this.content.length+"px"});var b=(a.width-80)/this.content.length,d=(new Banana.Controls.Panel).setCss({width:100*(40/a.width)+"%"}).addCssClass("BTabSliderlinkWrapper");this.buttonContainer.addControl(d);var e=(new Banana.Controls.Link).addCssClass("BTabSliderLink BTabSliderLinkPrevious");e.addControl(this.linkPreviousText);e.setHref("#previous tab");d.addControl(e);e.bind("click",this.getProxy(function(){this.activatedTab=this.ensureValidTab(--this.activatedTab);this.repositionPanels(this.slideSpeed);
return!1}));for(d=0,e=this.content.length;d<e;d++){var f=(new Banana.Controls.Panel).setCss({width:100*(b/a.width)+"%"}).addCssClass("BTabSliderlinkWrapper");this.buttonContainer.addControl(f);var g=(new Banana.Controls.Link).addCssClass("BTabSliderLink");g.addControl(this.content[d].tabname);g.setHref("#"+this.content[d].tabname);f.addControl(g);g.bind("click",this.getProxy(function(a){this.activatedTab=parseInt(a.data,10);this.repositionPanels(this.slideSpeed);return!1}),d.toString());f=(new Banana.Controls.Panel).addCssClass("BTabSliderContentItemContainer");
f.setCss({width:a.width+"px"});f.addControl(this.content[d].content);this.contentContainer.addControl(f)}a=(new Banana.Controls.Panel).setCss({width:100*(40/a.width)+"%"}).addCssClass("BTabSliderlinkWrapper");this.buttonContainer.addControl(a);b=(new Banana.Controls.Link).addCssClass("BTabSliderLink BTabSliderLinkNext");b.addControl(this.linkNextText);b.setHref("#previous tab");a.addControl(b);b.bind("click",this.getProxy(function(){this.activatedTab=this.ensureValidTab(++this.activatedTab);this.repositionPanels(this.slideSpeed);
return!1}));this.buttonContainer.invalidateDisplay();this.contentContainer.invalidateDisplay();this.repositionPanels(0)},ensureValidTab:function(a){0>a?a=this.content.length-1:a>this.content.length-1&&(a=0);return a},applyAutoHeight:function(){this.setCss({height:this.content[this.activatedTab].content.getDimensions().height+this.buttonContainer.getDimensions().height})},registerUrlHistory:function(){Banana.Util.UrlManager.registerModule(this.urlKey);Banana.Util.UrlManager.listenModule(this.urlKey,
this.getProxy(function(a,b){this.activatedTab=b;this.repositionPanels(this.slideSpeed)}))},repositionPanels:function(a){this.triggerEvent("onSlide");this.useAutoHeight&&this.applyAutoHeight();var b=-1*this.activatedTab*this.getDimensions().width;jQuery("#"+this.buttonContainer.getClientId()+" .BTabSliderLink").removeClass("BTabSliderLinkActive");jQuery("#"+this.buttonContainer.getClientId()+" .BTabSliderLink:eq("+(parseInt(this.activatedTab)+1)+")").addClass("BTabSliderLinkActive");jQuery("#"+this.contentContainer.getClientId()).animate({left:b+
...
namespace("Banana").Application=Banana.Control.extend({init:function(a){log=new Banana.Util.LogManager;log.addLogger(new Banana.Util.Logger.Console);log.setLevel("error",!0);log.setLevel("warning",!0);try{jQuery()}catch(b){log.error("JQuery is not found. JQuery required.")}a||(a={});this.settings=a;this.sectionVerticalScrollPosition={};this.id=0;a.applicationName?namespace("Banana")[a.applicationName]=this:namespace("Banana").Application=this;if(!a.pageTemplate)a.pageTemplate="PageTemplate";if(!a.paths)a.paths=
{};if(!a.paths.pages)a.paths.pages="Application.Pages";this.prepareUnload()},prepareUnload:function(){jQuery(window).unload(this.getProxy(function(){jQuery("*").unbind();this.activePage&&this.activePage.remove();this.pageTemplate&&this.pageTemplate.remove();Banana=null}))},loadPageTemplate:function(){if(this.settings.paths.pageTemplates)var a=this.settings.paths.pageTemplates+"."+this.settings.pageTemplate,b=Banana.Util.NamespaceToFunction(a);else b=Banana.PageTemplate;if(b)try{this.pageTemplate=
...
this.getProxy(function(){if(this.activePage)this.activePage.removeDom(),this.activePage.clearProps(),this.activePage=void 0;this.activePage=this.page;this.activePage.setVisible(!0)}));this.page.setVisible(!1);this.pageTemplate.addPageControl(this.page);this.pageTemplate.setApplication(this);this.pageTemplate.run(this)},run:function(a){if(a)this.page=a;if(a instanceof Banana.Page)return this.instantiateSinglePage();this.triggerEvent("onPreLoadPage");this.activePage||Banana.Util.UrlManager.autoRegisterModules();
...
b+" not found. Load default page "+this.settings.defaultSection);return this.loadPage(this.settings.defaultSection)}this.id++;var d=new a;d.bind("renderComplete",this.getProxy(function(){if(this.activePage)this.activePage.removeDom(),this.activePage.clearProps(),this.activePage=void 0;this.activePage=d;this.activePage.setVisible(!0)}));d.setVisible(!1);this.pageTemplate.addPageControl(d);this.pageTemplate.setApplication(this);this.pageTemplate.run();Banana.Util.UrlManager.updateUrl()});this.activePage?
...
a,!0)}});var Application={Pages:{}};Application.Pages.PageTemplates={};Application.Pages.PageTemplates.PageTemplate={};
namespace("Application.Pages.PageTemplates").PageTemplate=Banana.PageTemplate.extend({init:function(){this._super();this.addCssClass("DemoTemplate")},createComponents:function(){this.top=new Banana.Controls.Panel;this.top.addCssClass("DemoTopContainer");this.addControl(this.top);this.createLinks();var a=new Banana.Controls.Panel;a.addCssClass("DemoPageContent");this.addControl(a);a.addControl(this.content);a.addControl('<div style="clear:both;"></div>')},createLinks:function(){var a=new Banana.Controls.Panel;
a.addCssClass("DemoLinkPanel");this.top.addControl(a);var b=new Banana.Controls.Link;b.addControl("Home");b.bind("click",this.getProxy(function(a){Banana.Application.loadPage("Home");a.preventDefault()}));b.setHref("#section=Home");a.addControl(b)}});Application.Controls={};Application.Controls.HomeTileItemRender={};
namespace("Application.Controls").HomeTileLittle=Banana.Controls.DataControl.extend({createComponents:function(){var a=new Banana.Controls.Panel;a.addCssClass("DemoHomeTileTitle");a.addControl(this.data.title);var b=new Banana.Controls.Panel;b.addCssClass("DemoHomeTileContents");b.addControl(this.data.contents);var d=new Banana.Controls.Link;d.addControl("View");d.bind("click",this.getProxy(function(){this.triggerEvent("onView")}));var e=new Banana.Controls.Panel;e.addCssClass("DemoHomeTileLinkContainer");
e.addControl(d);this.addControl(a);this.addControl(b);this.addControl(e)}});
namespace("Application.Controls").HomeTileBig=Banana.Controls.DataControl.extend({createComponents:function(){var a=new Banana.Controls.Panel;a.addCssClass("DemoHomeTileTitle");a.addControl(this.data.title);var b=new Banana.Controls.Panel;b.addCssClass("DemoHomeTileContents DemoHomeTileBigContents");var d=new Banana.Controls.Link;d.setVisible(!1);d.addControl("Close");d.bind("click",this.getProxy(function(){this.triggerEvent("onClose")}));this.link=d;this.contents=b;var e=new Banana.Controls.Panel;
e.addCssClass("DemoHomeTileLinkContainer");e.addControl(d);this.addControl(a);this.addControl(b);this.addControl(e)},onGrown:function(){this.link.setVisible(!0,300,"fadeIn");if(this.data.control){var a=Banana.Util.NamespaceToFunction(this.data.control);if(a)a=new a,a.setVisible(!1),this.inst=a,a.setCss({height:this.contents.getDimensions().height+"px",overflow:"auto"}),a.setVisible(!0,300,"fadeIn"),this.contents.addControl(a),this.contents.invalidateDisplay()}},onShrinkStart:function(a){this.link.setVisible(!1,
300);this.inst?this.inst.setVisible(!1,100,"fadeOut",function(){a&&a()}):a&&a()}});
namespace("Application.Controls").HomeTileItemRender=Banana.Controls.DataGridTileItemRender.extend({createComponents:function(){this.panel=new Banana.Controls.Panel;this.panel.addCssClass("DemoHomeTile");var a=new Application.Controls.HomeTileLittle;a.data=this.data;a.bind("onView",this.getProxy(function(){if(!this.disableClicks)this.disableClicks=!0,this.grow()}));this.panel.addControl(a);this.addControl(this.panel)},grow:function(){var a=this,b=this.getListRender().getItemRenderPlaceHolderByItemRender(this).getDimensions(),
d=new Banana.Controls.Panel;d.setCss({"z-index":999999,position:"absolute",background:"#444444",width:100/3+"%",left:b.position.left+"px",top:b.position.top+"px","-webkit-box-sizing":"border-box"});var e=new Application.Controls.HomeTileBig;e.data=this.data;e.addCssClass("BDemoHomeTileeBig");e.bind("onClose",function(){e.onShrinkStart(function(){jQuery("#"+d.clientId).animate({width:100/3+"%",height:b.height+"px",left:b.position.left+"px",top:b.position.top+"px"},{duration:300,easing:"swing",complete:function(){jQuery("#"+
d.clientId).siblings().css({opacity:1});d.remove();a.disableClicks=!1;var b=a.listRender.getIndexByItemRender(a);a.listRender.triggerEvent("onShrink",{index:b})}})})});d.addControl(e);this.getListRender().controls[0].addControl(d,!0);jQuery("#"+d.clientId).siblings().css({opacity:0.8});jQuery("#"+d.clientId).animate({width:"100%",height:"100%",left:0,top:0},{duration:300,easing:"swing",complete:this.getProxy(function(){e.onGrown();var b=a.listRender.getIndexByItemRender(a);a.listRender.triggerEvent("onGrow",
{index:b});a.disableClicks=!1})})},updateDisplay:function(){this.panel.setCss({height:Math.round(0.7*this.panel.getDimensions().width)})},select:function(){this.panel.addCssClass("ExampleTileSimple2ItemRenderSelected")},deselect:function(){this.panel.removeCssClass("ExampleTileSimple2ItemRenderSelected")},getIsSelectable:function(){return!1}});Application.Controls.Datagrids={};Application.Controls.Datagrids.TablegridSimple={};
namespace("Application.Controls.Datagrids").TablegridSimple=Banana.Controls.Panel.extend({createComponents:function(){var a=[(new Banana.Controls.DataGridColumn).setHeaderText("Id").setDataField("id"),(new Banana.Controls.DataGridColumn).setHeaderText("Name").setDataField("name"),(new Banana.Controls.DataGridColumn).setHeaderText("Description").setDataField("description"),(new Banana.Controls.DataGridColumn).setHeaderText("Color").setDataField("color").bind("onItemCreated",this.getProxy(function(a,
...
this.filterManager.bind("filtersChanged",this.getProxy(function(){this.populateGrid()}));this.filterManager.setFilters([(new Banana.Controls.DataGridDropDownFilter).setFilterField("country").setAllTitle("All countries").setId("piet").setDataSource(["Spain","Peru"]),(new Banana.Controls.DataGridDropDownFilter).setFilterField("color").setAllTitle("All colors").setDataKeyField("key").setDataValueField("value").setDataSource([{key:1,value:"Red"},{key:2,value:"Yellow"}]),(new Banana.Controls.DataGridSearchFilter).setFilterField("search").bind("filterDataChanged",
this.getProxy(function(){this.pagerFilter.setData(0)})),this.pagerFilter=(new Banana.Controls.DataGridPagerFilter).setFilterField("pageIndex")])},getDataSource:function(){return[{id:1,name:"Orange",description:"Mare neque",country:"Peru",color:1},{id:2,name:"Apple",description:"Diam a nulla placerat ru",country:"Spain",color:1},{id:3,name:"Banana",description:"Llis eros eget mauri",country:"Spain",color:1},{id:4,name:"Orange",description:"Morbi sollicitudin",country:"Peru",color:2},{id:5,name:"Bolwara",
description:"Er in adipiscing turpis.",country:"Peru",color:1},{id:6,name:"Guava",description:"Odio auctor enim",country:"Peru",color:1},{id:7,name:"Ilium",description:"Odio auctor enim",country:"Peru",color:1},{id:8,name:"Bongo",description:"Odio auctor enim",country:"Peru",color:1},{id:9,name:"Herma",description:"Odio auctor enim",country:"Peru",color:1},{id:10,name:"Frukta",description:"Odio auctor enim",country:"Peru",color:1},{id:11,name:"Herama",description:"Odio auctor enim",country:"Peru",
color:1},{id:12,name:"Chi es",description:"Odio auctor enim",country:"Peru",color:1},{id:13,name:"Londop",description:"Odio auctor enim",country:"Peru",color:1},{id:14,name:"Ermito",description:"Odio auctor enim",country:"Peru",color:2},{id:15,name:"Hasumilo",description:"Odio auctor enim",country:"Peru",color:1},{id:16,name:"Fermi",description:"Odio auctor enim",country:"Peru",color:1},{id:17,name:"Bon emin",description:"Odio auctor enim",country:"Peru",color:1},{id:18,name:"Lekker",description:"Odio auctor enim",
country:"Peru",color:2},{id:19,name:"Fuit",description:"Odio auctor enim",country:"Peru",color:1},{id:20,name:"Derie",description:"Odio auctor enim",country:"Peru",color:2},{id:21,name:"Humop",description:"Odio auctor enim",country:"Peru",color:2}]},getFilteredDataSource:function(){var a=this.filterManager.getFilterData(),b=this.getDataSource(),b=this.filterDataSource("country",a,b),b=this.filterDataSource("color",a,b);return b=this.searchDataSource(b)},filterDataSource:function(a,b,d){var e=[];if("%"!=
b[a].data)for(var f=0;f<d.length;f++)d[f][a]==b[a].data&&e.push(d[f]);else return d;return e},searchDataSource:function(a,b){var b=this.filterManager.getFilterData().search,d,e,f=[];if("%"==b.data)return a;for(d=0,e=a.length;d<e;d++)for(key in a[d])if("string"==typeof a[d][key]&&a[d][key].toLowerCase().match(b.data.toLowerCase())){f.push(a[d]);goToNext=!0;break}return f},filterPageDataSource:function(a,b){var d=[];if(!b.pageIndex||0==b.pageIndex.data)var e=0,f=this.pageSize;else e=b.pageIndex.data*
this.pageSize,f=e+this.pageSize;for(var g=a.length;e<f&&!(e>=g);e++)d.push(a[e]);return d}});Application.Controls.Datagrids.TablegridCustomItemRender={};
namespace("Application.Controls.Datagrids").TablegridCustomItemRender=Banana.Controls.Panel.extend({createComponents:function(){this.datagrid=new Banana.Controls.DataGrid;var a=this.datagrid.getListRender();a.setItemRender(Application.Controls.Datagrids.CustomItemRender);a.setColumns(this.getColumns());this.addControl(this.datagrid);this.populateGrid()},populateGrid:function(){this.datagrid.setDataSource(this.getDataSource())},getColumns:function(){return[(new Banana.Controls.DataGridButtonColumn).setButtonText("Edit").setHeaderText("Id").setStyle("width:50px;"),(new Banana.Controls.DataGridColumn).setHeaderText("Id").setDataField("id"),
(new Banana.Controls.DataGridColumn).setHeaderText("Name").setDataField("name"),(new Banana.Controls.DataGridColumn).setHeaderText("Description").setDataField("description"),(new Banana.Controls.DataGridColumn).setHeaderText("Color").setDataField("color").bind("onItemCreated",this.getProxy(function(a,b){1==b.data.color?b.control.setData("red"):b.control.setData("yellow")})),(new Banana.Controls.DataGridColumn).setHeaderText("Country").setDataField("country").setSortField("country")]},getDataSource:function(){return[{id:1,
name:"Orange",description:"Mare neque",country:"Peru",color:1},{id:2,name:"Apple",description:"Diam a nulla placerat ru",country:"Spain",color:1},{id:3,name:"Banana",description:"Llis eros eget mauri",country:"Spain",color:1},{id:4,name:"Orange",description:"Morbi sollicitudin",country:"Peru",color:1},{id:5,name:"Bolwara",description:"Er in adipiscing turpis.",country:"Peru",color:1}]}});
namespace("Application.Controls.Datagrids").CustomItemRender=Banana.Controls.DataGridTableContentItemRender.extend({createColumns:function(a){for(var b=this.listRender.columns,d=0,e=b.length;d<e;d++){var f=b[d],g=f.getControl();0==d&&g.setImage(Banana.Application.settings.imagedir+"/arrowclose.png");f.getDataField()&&g.setData(Banana.Util.getDataByPath(this.getData(),f.getDataField()));var h=new Banana.Controls.TableCol;h.setStyle(f.getStyle());h.addControl(g);a.addControl(h);f.triggerEvent("onItemCreated",
{control:g,data:this.getData()})}},createExtraControls:function(a){var b=[(new Banana.Controls.DataGridColumn).setHeaderText("# Ordered").setDataField("ordered"),(new Banana.Controls.DataGridColumn).setHeaderText("By").setDataField("by"),(new Banana.Controls.DataGridColumn).setHeaderText("Date").setDataField("date")],d=new Banana.Controls.DataGrid;d.getListRender().setColumns(b);d.setDataSource([{ordered:"123",date:"2011-12-12",by:"John"},{ordered:"6578",date:"2011-12-12",by:"John"},{ordered:"543",
date:"2011-12-12",by:"Sue"}]);a.addControl(d)},getIsSelectable:function(){return!1}});
namespace("Application.Controls.Datagrids").CustomItemRender2=Banana.Controls.DataGridTableContentItemRender.extend({createComponents:function(){this.mainColumn=new Banana.Controls.TableCol;this.mainColumn.setAttribute("colSpan",this.listRender.columns.length);this.mainColumn.addCssClass("examplesCustomItemRender");this.addControl(this.mainColumn);this.table=new Banana.Controls.Table;this.mainColumn.addControl(this.table);var a=new Banana.Controls.TableRow;a.setStyle("padding:0;margin:0;");this.table.addControl(a);
...
f.bind("click",this.getProxy(function(){var a={};a.index=this.getListRender().getIndexByItemRender(this);this.getListRender().triggerEvent("resetItemRender",a)}));b.addControl(a);b.addControl(f)},getIsSelectable:function(){return!1}});Banana.Controls.YoutubeIFramePlayer={};
namespace("Banana.Controls").YoutubeIFramePlayer=Banana.Controls.Panel.extend({init:function(a,b){this._super();this.height=b;this.width=a;this.createRequiredApiStructures()},createRequiredApiStructures:function(){if(!window.youtubeApiScripsLoaded){var a=document.createElement("script");a.src="http://www.youtube.com/player_api?wmode=transparent";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);window.youtubeApiScripsLoaded=!0}if(!window.queuedBananaYouTubePlayers)window.queuedBananaYouTubePlayers=[];
if(!window.youtubeApiReadyCallback)window.onYouTubePlayerAPIReady=function(){for(var a=0;a<window.queuedBananaYouTubePlayers.length;a++)window.queuedBananaYouTubePlayers[a]();window.youtubeApiReady=!0}},isApiReady:function(){return!0==window.youtubeApiReady},unload:function(){window.queuedBananaYouTubePlayers=void 0},createComponents:function(){this.placeHolder=new Banana.Controls.Panel;this.buttonHolder=new Banana.Controls.Panel;this.addControl(this.placeHolder);this.addControl(this.buttonHolder)},
updateDisplay:function(){this.createPlayer()},createPlayer:function(){this.placeHolder.clear();var a=this.getDimensions();if(!this.height)this.height=a.height;if(!this.width)this.width=a.width;if(!this.added)this.added=!0,window.queuedBananaYouTubePlayers.push(this.getProxy(function(a){return this.getProxy(function(){this.player=new YT.Player(a.id,{height:a.height,width:a.width,playerVars:{wmode:"transparent",cc_load_policy:0,iv_load_policy:3,showinfo:0,rel:0,modestbranding:1,controls:0,showsearch:0},
events:{onReady:this.getProxy(function(a){this.playerIsReady(a)}),onStateChange:this.getProxy(function(a){this.playerStateChanged(a)})}})})})({id:this.placeHolder.getClientId(),data:this.data,width:this.width,height:this.height})),this.isApiReady()&&(console.log(this.id,"directly create"),window.queuedBananaYouTubePlayers[window.queuedBananaYouTubePlayers.length-1]())},loadVideoById:function(a){this.getPlayer()?(this.duration=null,this.getPlayer().loadVideoById(a)):console.log(this.id,"no player")},
cueVideoById:function(a){this.getPlayer()?(this.duration=null,this.getPlayer().cueVideoById(a)):console.log(this.id,"no player")},setVolume:function(a){this.getPlayer()?this.getPlayer().setVolume(a):log.error("no player")},mute:function(){this.getPlayer()?this.getPlayer().mute():log.error("no player")},getDuration:function(){if(this.getPlayer())return this.getPlayer().getDuration();log.error("no player")},getCurrentTime:function(){if(this.getPlayer())return new Banana.Util.DateTimecode(1E3*this.getPlayer().getCurrentTime());
log.error("no player")},getPlayerState:function(){if(this.getPlayer())return this.getPlayer().getPlayerState();log.error("no player")},seekTo:function(a,b){if(this.getPlayer())return this.getPlayer().seekTo(a,b);log.error("no player")},pauseVideo:function(){if(this.getPlayer())return this.getPlayer().pauseVideo();log.error("no player")},stopVideo:function(){if(this.getPlayer())return this.getPlayer().stopVideo();log.error("no player")},getPlayer:function(){if(this.playerReady)return this.player;log.error("no player")},
playerStateChanged:function(a){if(this.duration!=this.getDuration())this.duration=this.getDuration(),this.triggerEvent("onDurationKnown",new Banana.Util.DateTimecode(1E3*this.duration));this.triggerEvent("onPlayerStateChanged",a)},playerIsReady:function(){this.playerReady=!0;try{this.triggerEvent("onPlayerReady")}catch(a){console.log(a)}}});Application.Controls.Datagrids.TilegridCustomItemRender={};
namespace("Application.Controls.Datagrids").TilegridCustomItemRender=Banana.Controls.Panel.extend({createComponents:function(){grid=new Banana.Controls.DataGrid;var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.Datagrids.YoutubeItemRender});a.addCssClass("playergrid");a.setPlaceHolderWidth("25%;");grid.setListRender(a);grid.setDataSource("C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c,C0DPdy98e4c".split(","));this.addControl(grid)}});
namespace("Application.Controls.Datagrids").YoutubeItemRender=Banana.Controls.DataGridTileItemRender.extend({createComponents:function(){this.panel=new Banana.Controls.Panel;this.panel.addCssClass("youtubetile");this.addControl(this.panel)},updateDisplay:function(){var a=this.panel.getDimensions(),b=a.width/1.6;this.panel.setCss({height:b+"px"});console.log(a.width,b);var d=new Banana.Controls.YoutubeIFramePlayer(a.width,b);d.addCssClass("player");d.bind("onPlayerReady",this.getProxy(function(){d.loadVideoById(this.data)}));
this.panel.addControl(d);this.panel.invalidateDisplay()},select:function(){this.panel.addCssClass("ExampleTileSimple2ItemRenderSelected")},deselect:function(){this.panel.removeCssClass("ExampleTileSimple2ItemRenderSelected")},mouseOver:function(){this.panel.addCssClass("ExampleTileSimple2ItemRenderMouseover")},mouseOut:function(){this.panel.removeCssClass("ExampleTileSimple2ItemRenderMouseover")},getIsSelectable:function(){return!1}});Application.Pages.MyPage={};
namespace("Application.Pages").Home=Banana.Page.extend({createComponents:function(){var a=new Banana.Controls.TabSlider;a.setUseAutoHeight(!0);a.setSlideSpeed(500);a.setStyle("width:100%;");a.setUseUrlHistory(!0);this.addControl(a);a.addContent(this.getDataGridOverview(),"Table datagrids");a.addContent(this.getTileGridOverview(),"Tile datagrids");a.addContent(this.getTreeGridOverview(),"Tree datagrids")},getDataGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTableDataGrids");
var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");a.bind("onGrow",this.getProxy(function(){}));grid.setListRender(a);grid.setDataSource([{title:"Basic Table datagrid",control:"Application.Controls.Datagrids.TablegridSimple",open:!0,contents:"Table datagrid shows a vertical list of items devided in rows and columns."},{title:"Filterable",control:"Application.Controls.Datagrids.TablegridFilterable",
contents:"Table datagrid with filterable components"},{title:"Custom item render",control:"Application.Controls.Datagrids.TablegridCustomItemRender",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Dynamic data coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Dynamic updating the contents of the list"}]);
return grid},getTileGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTileDataGrids");var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Tile datagrid",link:"ewrwe",contents:"Tile datagrid in a simple form"},{title:"Selectables",link:"ewrwe",contents:"Selectable tiles"},{title:"Custom item render",control:"Application.Controls.Datagrids.TilegridCustomItemRender",
contents:"In this example we show a grid of youtube players"},{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Simulate data population coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Adding and removing tiles based on updated datasource"}]);return grid},getTreeGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTreeDataGrids");var a=new Banana.Controls.DataGridTileListRender;
a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Table datagrid",link:"ewrwe",contents:"Table datagrid shows a vertical list of items devided in rows and columns."},{title:"Filterable",link:"ewrwe",contents:"Table datagrid with filterable components"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",
link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Dynamic data coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Dynamic updating the contents of the list"}]);return grid}});

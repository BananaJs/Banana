...
COMPILED||(goog.isProvided_=function(a){return!goog.implicitNamespaces_[a]&&!!goog.getObjectByName(a)},goog.implicitNamespaces_={});goog.exportPath_=function(a,b,d){a=a.split(".");d=d||goog.global;!(a[0]in d)&&d.execScript&&d.execScript("var "+a[0]);for(var e;a.length&&(e=a.shift());)!a.length&&goog.isDef(b)?d[e]=b:d=d[e]?d[e]:d[e]={}};goog.getObjectByName=function(a,b){for(var d=a.split("."),e=b||goog.global,f;f=d.shift();)if(goog.isDefAndNotNull(e[f]))e=e[f];else return null;return e};
goog.globalize=function(a,b){var d=b||goog.global,e;for(e in a)d[e]=a[e]};goog.addDependency=function(a,b,d){if(!COMPILED){for(var e,a=a.replace(/\\/g,"/"),f=goog.dependencies_,g=0;e=b[g];g++){f.nameToPath[e]=a;a in f.pathToNames||(f.pathToNames[a]={});f.pathToNames[a][e]=true}for(e=0;b=d[e];e++){a in f.requires||(f.requires[a]={});f.requires[a][b]=true}}};goog.ENABLE_DEBUG_LOADER=!0;
...
!COMPILED&&goog.ENABLE_DEBUG_LOADER&&(goog.included_={},goog.dependencies_={pathToNames:{},nameToPath:{},requires:{},visited:{},written:{}},goog.inHtmlDocument_=function(){var a=goog.global.document;return typeof a!="undefined"&&"write"in a},goog.findBasePath_=function(){if(goog.global.CLOSURE_BASE_PATH)goog.basePath=goog.global.CLOSURE_BASE_PATH;else if(goog.inHtmlDocument_())for(var a=goog.global.document.getElementsByTagName("script"),b=a.length-1;b>=0;--b){var d=a[b].src,e=d.lastIndexOf("?"),
e=e==-1?d.length:e;if(d.substr(e-7,7)=="base.js"){goog.basePath=d.substr(0,e-7);break}}},goog.importScript_=function(a){var b=goog.global.CLOSURE_IMPORT_SCRIPT||goog.writeScriptTag_;!goog.dependencies_.written[a]&&b(a)&&(goog.dependencies_.written[a]=true)},goog.writeScriptTag_=function(a){if(goog.inHtmlDocument_()){goog.global.document.write('<script type="text/javascript" src="'+a+'"><\/script>');return true}return false},goog.writeScripts_=function(){function a(f){if(!(f in e.written)){if(!(f in
e.visited)){e.visited[f]=true;if(f in e.requires)for(var h in e.requires[f])if(!goog.isProvided_(h))if(h in e.nameToPath)a(e.nameToPath[h]);else throw Error("Undefined nameToPath for "+h);}if(!(f in d)){d[f]=true;b.push(f)}}}var b=[],d={},e=goog.dependencies_,f;for(f in goog.included_)e.written[f]||a(f);for(f=0;f<b.length;f++)if(b[f])goog.importScript_(goog.basePath+b[f]);else throw Error("Undefined script input");},goog.getPathFromDeps_=function(a){return a in goog.dependencies_.nameToPath?goog.dependencies_.nameToPath[a]:
...
goog.UID_PROPERTY_="closure_uid_"+Math.floor(2147483648*Math.random()).toString(36);goog.uidCounter_=0;goog.getHashCode=goog.getUid;goog.removeHashCode=goog.removeUid;goog.cloneObject=function(a){var b=goog.typeOf(a);if(b=="object"||b=="array"){if(a.clone)return a.clone();var b=b=="array"?[]:{},d;for(d in a)b[d]=goog.cloneObject(a[d]);return b}return a};goog.bindNative_=function(a,b,d){return a.call.apply(a.bind,arguments)};
goog.bindJs_=function(a,b,d){if(!a)throw Error();if(arguments.length>2){var e=Array.prototype.slice.call(arguments,2);return function(){var d=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(d,e);return a.apply(b,d)}}return function(){return a.apply(b,arguments)}};goog.bind=function(a,b,d){goog.bind=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?goog.bindNative_:goog.bindJs_;return goog.bind.apply(null,arguments)};
...
b.body.appendChild(d);b.body.removeChild(d)}}else throw Error("goog.globalEval not available");};goog.evalWorksForGlobals_=null;goog.getCssName=function(a,b){var d=function(a){return goog.cssNameMapping_[a]||a},e;e=goog.cssNameMapping_?goog.cssNameMappingStyle_=="BY_WHOLE"?d:function(a){for(var a=a.split("-"),b=[],e=0;e<a.length;e++)b.push(d(a[e]));return b.join("-")}:function(a){return a};return b?a+"-"+e(b):e(a)};
goog.setCssNameMapping=function(a,b){goog.cssNameMapping_=a;goog.cssNameMappingStyle_=b};!COMPILED&&goog.global.CLOSURE_CSS_NAME_MAPPING&&(goog.cssNameMapping_=goog.global.CLOSURE_CSS_NAME_MAPPING);goog.getMsg=function(a,b){var d=b||{},e;for(e in d)var f=(""+d[e]).replace(/\$/g,"$$$$"),a=a.replace(RegExp("\\{\\$"+e+"\\}","gi"),f);return a};goog.exportSymbol=function(a,b,d){goog.exportPath_(a,b,d)};goog.exportProperty=function(a,b,d){a[b]=d};
...
goog.base=function(a,b,d){var e=arguments.callee.caller;if(e.superClass_)return e.superClass_.constructor.apply(a,Array.prototype.slice.call(arguments,1));for(var f=Array.prototype.slice.call(arguments,2),g=false,h=a.constructor;h;h=h.superClass_&&h.superClass_.constructor)if(h.prototype[b]===e)g=true;else if(g)return h.prototype[b].apply(a,f);if(a[b]===e)return a.constructor.prototype[b].apply(a,f);throw Error("goog.base called from a method of one name to a method of a different name");};
goog.scope=function(a){a.call(goog.global)};var Banana={Util:{}};Banana.Util.NameSpace={};var namespace=function(a,b,d){var a=a.split(b||"."),d=d||window,e,b=0;for(e=a.length;b<e;b++)d=d[a[b]]=d[a[b]]||{};return d};Banana.Util.Base={};
...
startChecking=function(){stopHandler=!1;g||startHandler()};startHandler=function(){g=!0;stopHandler?(clearTimeout(f),stopHandler=!1):(e||(e=function(){var a=getUrlObject(),b,e;for(e in d)b=a[e]||"",d[e]&&a[e]&&d[e].bhmValue!=b&&(d[e].bhmValue=b,jQuery(document).trigger("url."+e,[b,e]));startHandler()}),f=setTimeout(e,50))};stopChecking=function(){stopHandler=!0;clearTimeout(f);f=null;g=!1};return{registerModule:function(a){d[a]||(d[a]={});d[a].bhmValue=getUrlObject()[a]?getUrlObject()[a]:""},autoRegisterModules:function(){params=
...
b==o&&f.completed.call(m)}return!1}function w(a,b){for(var d=a;d<b&&d<o;d++)h[d]&&(p[d]=f.placeholder)}function u(){return m.val(p.join("")).val()}function s(a){for(var b=m.val(),d=-1,e=0,g=0;e<o;e++)if(h[e]){for(p[e]=f.placeholder;g++<b.length;){var k=b.charAt(g-1);if(h[e].test(k)){p[e]=k;d=e;break}}if(g>b.length)break}else p[e]==b[g]&&e!=j&&(g++,d=e);if(!a&&d+1<j)m.val(""),w(0,o);else if(a||d+1>=j)u(),a||m.val(m.val().substring(0,d+1));return j?e:n}var m=a(this),p=a.map(e.split(""),function(a){if("?"!=
...
!0,this.createLoadMoreButton(a,e,d)}d.loadnext=!1}},createItemRenderByIndex:function(a,b,d){var e=this.getDataSourceByIndex(a),f=this.nodeData[e[this.indexKey]];this.toLogger("create item render by index ",a,e);this.triggerEvent("onPreCreateItem",{index:a,data:e});if(f){this.currentIndexCreation=a;var g=null,h=e[this.indexKey],g=h&&this.dataItemRenderMap.getItem(h)?this.dataItemRenderMap.getItem(h):this.indexItemRenderFactory[a]?this.indexItemRenderFactory[a]:this.defaultContentItemRender,k=this.getObject(g);
k.setData(e);k.bind("dataChanged",this.getProxy(function(a){this.getDataSource()[parseInt(a.data,10)]=a.currentTarget.getData();this.triggerEvent("dataSourceChanged")}),a.toString());this.dataItemRenderMap.addItem(h,g);this.indexRenderedItemRenderMap[a]=k;k.setListRender(this);var g=this.getParentHolder(a),j=null;d?(j=this.getHolder(a),j.getItemRenderHolder().clear()):g?(j=this.getHolder(a),j=new Banana.Controls.DataGridTreeListHolder):(this.rootHolder=new Banana.Controls.DataGridTreeListRootHolder,
...
this.getProxy(function(){this.onSetData();this.dropDown.setData(this.getData());this.createDropDownDataSource();null!=this.datasource&&this.createPageLinks();this.triggerEvent("filterDataChanged",!0)}));this.bind("dataSourceChanged",this.getProxy(function(){null==this.data&&(this.data=0);null!=this.data&&(this.createPageLinks(),this.createDropDownDataSource());this.triggerEvent("filterDataSourceChanged")}));this.bind("indexChanged",this.getProxy(function(){this.createDropDownDataSource();this.triggerEvent("filterDataChanged")}))}});
...
namespace("Banana").Application=Banana.Control.extend({init:function(a){log=new Banana.Util.LogManager;log.addLogger(new Banana.Util.Logger.Console);log.setLevel("error",true);log.setLevel("warning",true);try{jQuery()}catch(b){log.error("JQuery is not found. JQuery required.")}a||(a={});this.settings=a;this.sectionVerticalScrollPosition={};this.id=0;a.applicationName?namespace("Banana")[a.applicationName]=this:namespace("Banana").Application=this;if(!a.pageTemplate)a.pageTemplate="PageTemplate";if(!a.paths)a.paths=
...
if(this.loadingWithHistory=!d){var e=Banana.Util.UrlManager.getModuleHistory(a),f;for(f in e)if(e.hasOwnProperty(f)){Banana.Util.UrlManager.registerModule(f);Banana.Util.UrlManager.setModule(f,e[f],true)}}if(b)for(var g in b)if(b.hasOwnProperty(g)){Banana.Util.UrlManager.registerModule(g);Banana.Util.UrlManager.setModule(g,b[g],true)}this.run(a);d||window.scrollTo(0,this.getSectionVerticalScrollPosition(a)||0)},instantiateSinglePage:function(){this.pageTemplate||this.loadPageTemplate();this.page.bind("renderComplete",
this.getProxy(function(){if(this.activePage){this.activePage.removeDom();this.activePage.clearProps();this.activePage=void 0}this.activePage=this.page;this.activePage.setVisible(true)}));this.page.setVisible(false);this.pageTemplate.addPageControl(this.page);this.pageTemplate.setApplication(this);this.pageTemplate.run(this)},run:function(a){if(a)this.page=a;if(a instanceof Banana.Page)return this.instantiateSinglePage();this.triggerEvent("onPreLoadPage");this.activePage||Banana.Util.UrlManager.autoRegisterModules();
...
b+" not found. Load default page "+this.settings.defaultSection);return this.loadPage(this.settings.defaultSection)}this.id++;var d=new a;d.bind("renderComplete",this.getProxy(function(){if(this.activePage){this.activePage.removeDom();this.activePage.clearProps();this.activePage=void 0}this.activePage=d;this.activePage.setVisible(true)}));d.setVisible(false);this.pageTemplate.addPageControl(d);this.pageTemplate.setApplication(this);this.pageTemplate.run();Banana.Util.UrlManager.updateUrl()});if(this.activePage){Banana.Util.UrlManager.stopChecking();
this.activePage.remove(true,this.getProxy(function(){Banana.Util.UrlManager.startChecking();d();Banana.Util.UrlManager.listenModule("section",this.getProxy(function(){this.loadPage(Banana.Util.UrlManager.getModule("section"))}))}))}else{d();Banana.Util.UrlManager.listenModule("section",this.getProxy(function(){this.loadPage(Banana.Util.UrlManager.getModule("section"))}))}},registerUrlSection:function(a){Banana.Util.UrlManager.registerModule("section",a);Banana.Util.UrlManager.setModule("section",
a,true)}});var Application={Pages:{}};Application.Pages.PageTemplates={};Application.Pages.PageTemplates.PageTemplate={};
...
b[a].data)for(var f=0;f<d.length;f++)d[f][a]==b[a].data&&e.push(d[f]);else return d;return e},searchDataSource:function(a,b){var b=this.filterManager.getFilterData().search,d,e,f=[];if("%"==b.data)return a;d=0;for(e=a.length;d<e;d++)for(key in a[d])if("string"==typeof a[d][key]&&a[d][key].toLowerCase().match(b.data.toLowerCase())){f.push(a[d]);goToNext=!0;break}return f},filterPageDataSource:function(a,b){var d=[];if(!b.pageIndex||0==b.pageIndex.data)var e=0,f=this.pageSize;else e=b.pageIndex.data*
...
namespace("Banana.Controls").YoutubeIFramePlayer=Banana.Controls.Panel.extend({init:function(a,b,d){this._super();this.playerVars=d?d:{wmode:"transparent",cc_load_policy:0,iv_load_policy:3,showinfo:0,rel:0,modestbranding:1,controls:1,disablekb:1,fs:0,showsearch:0,origin:"barmania.mine.nu"};this.height=b;this.width=a;this.createRequiredApiStructures()},createRequiredApiStructures:function(){if(!window.youtubeApiScripsLoaded){var a=document.createElement("script");a.src="http://www.youtube.com/player_api?wmode=transparent";
var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);window.youtubeApiScripsLoaded=!0}window.queuedBananaYouTubePlayers||(window.queuedBananaYouTubePlayers=[]);window.youtubeApiReadyCallback||(window.onYouTubePlayerAPIReady=function(){for(var a=0;a<window.queuedBananaYouTubePlayers.length;a++)window.queuedBananaYouTubePlayers[a]();window.youtubeApiReady=true})},isApiReady:function(){return!0==window.youtubeApiReady},unload:function(){this.player&&this.player.destroy();window.queuedBananaYouTubePlayers=
void 0},createComponents:function(){this.placeHolder=new Banana.Controls.Panel;this.buttonHolder=new Banana.Controls.Panel;this.addControl(this.placeHolder);this.addControl(this.buttonHolder)},updateDisplay:function(){this.createPlayer()},createPlayer:function(){this.placeHolder.clear();var a=this.getDimensions();this.height||(this.height=a.height);this.width||(this.width=a.width);if(!this.added&&(this.added=!0,window.queuedBananaYouTubePlayers.push(this.getProxy(function(a){return this.getProxy(function(){this.player=
new YT.Player(a.id,{height:a.height,width:a.width,playerVars:this.playerVars,events:{onReady:this.getProxy(function(a){this.playerIsReady(a)}),onStateChange:this.getProxy(function(a){this.playerStateChanged(a)}),onError:this.getProxy(function(a){this.playerIsErrored(a)})}})})})({id:this.placeHolder.getClientId(),data:this.data,width:this.width,height:this.height})),this.isApiReady()))window.queuedBananaYouTubePlayers[window.queuedBananaYouTubePlayers.length-1]()},loadVideoById:function(a,b){this.getPlayer()?
(this.duration=null,this.getPlayer().loadVideoById(a,b)):console.log(this.id,"no player")},cueVideoById:function(a,b){this.getPlayer()?(this.duration=null,this.getPlayer().cueVideoById(a,b)):console.log(this.id,"no player")},setVolume:function(a){this.getPlayer()?this.getPlayer().setVolume(a):log.error("no player")},mute:function(){this.getPlayer()?(this.isMutedPasv=!0,this.getPlayer().mute()):log.error("no player")},unMute:function(){this.getPlayer()?(this.isMutedPasv=!1,this.getPlayer().unMute()):
log.error("no player")},isMuted:function(a){return a?this.isMutedPasv:!this.getPlayer()?(log.error("no player"),null):this.getPlayer().isMuted()},getDuration:function(){if(this.getPlayer())return this.getPlayer().getDuration();log.error("no player")},getCurrentTime:function(){if(this.getPlayer())return new Banana.Util.DateTimecode(1E3*this.getPlayer().getCurrentTime());log.error("no player")},getPlayerState:function(){if(this.getPlayer())return this.getPlayer().getPlayerState();log.error("no player")},
seekTo:function(a,b){if(this.getPlayer())return this.getPlayer().seekTo(a,b);log.error("no player")},playVideo:function(){if(this.getPlayer())return this.getPlayer().playVideo();log.error("no player")},pauseVideo:function(){if(this.getPlayer())return this.getPlayer().pauseVideo();log.error("no player")},stopVideo:function(){if(this.getPlayer())return this.getPlayer().stopVideo();log.error("no player")},getPlayer:function(){if(this.playerReady)return this.player;log.error("no player")},playerStateChanged:function(a){this.duration!=
this.getDuration()&&(this.duration=this.getDuration(),this.triggerEvent("onDurationKnown",new Banana.Util.DateTimecode(1E3*this.duration)));this.triggerEvent("onPlayerStateChanged",a)},playerIsReady:function(a){this.playerReady=!0;try{this.triggerEvent("onPlayerReady",a)}catch(b){console.log(b)}},playerIsErrored:function(a){console.log("player error",a);this.triggerEvent("onPlayerError",a)}});Application.Controls.Datagrids.TilegridCustomItemRender={};

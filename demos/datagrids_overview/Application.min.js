...
(a+=0===a.length?"":"&",a=a+b+"="+d[b].bhmValue);a!=g()&&("Microsoft Internet Explorer"==navigator.appName&&document.getElementById("URLFrame")&&(document.frames.URLFrame.location.replace(document.frames.URLFrame.location.pathname+"?"+location.hash.slice(1)),document.getElementById("URLFrame").setAttribute("src",document.frames.URLFrame.location.pathname+"?"+a)),location.hash=a)},j=function(){stopHandler=!1;e||(e=!0)},m={};$(window).unbind("hashchange");$(window).bind("hashchange",function(){if(e){for(var a=
event.target.location.hash.substring(1),b={},f,g=/\+/g,h=/([^&;=]+)=?([^&;]*)/g;f=h.exec(a);)b[decodeURIComponent(f[1].replace(g," "))]=decodeURIComponent(f[2].replace(g," "));$.each(b,function(a,b){d[a]&&void 0!=m[a]&&m[a]!==b&&jQuery(document).trigger("url."+a,[b,a]);m[a]=b})}});return{registerModule:function(a){d[a]||(d[a]={});d[a].bhmValue=f()[a]?f()[a]:""},autoRegisterModules:function(){params=f();for(param in params)param&&this.registerModule(param)},stopChecking:function(){e=!1},startChecking:function(){j()},
removeModules:function(){for(var a in d)e=!1,this.unlistenModule(a);d={}},clearUrl:function(){this.removeModules();this.removeListeners()},removeModule:function(a,b){e=!1;b?d[a].bhmValue="":(this.unlistenModule(a),delete d[a]);h();for(var f in d)return j()},setModule:function(a,b,f){if(a){if(!d[a])return!1;e=!1;d[a].bhmValue=b;!f&&(d[a]&&this.getModule[a]!=b)&&(h(),jQuery(document).trigger("url."+a,[b,a]));j()}},updateUrl:function(){h()},getModule:function(a){return d[a]&&d[a].bhmValue?d[a].bhmValue:
f()[a]?f()[a]:null},saveModuleHistory:function(){b[this.getModule("section")]=f()},getModuleHistory:function(a){return b[a]},getBrowserUrl:function(){return g()},getHistory:function(){return b},listenModule:function(b,d,f){f||(f={});e=!1;jQuery(document).bind("url."+b,f,d);a[b]=!0;j(b)},unlistenModule:function(b){jQuery(document).unbind("url."+b);delete a[b]},removeListeners:function(){for(l in a)"function"!=typeof a[l]&&this.unlistenModule(l);a=[]},getURLObject:function(){return f()},createUrlString:function(a,
b){if(b){b.section=a;var b=Banana.Util.sortObjectKeys(b),d="",e;for(e in b)d+="&"+e+"="+b[e];return d.substr(1,d.length)}return"section="+a}}}();Banana.Util.StateManager=function(){function a(a,d,e,f,g,h){a=a+"="+escape(d)+(e?"; expires="+e.toGMTString():"")+(f?"; path="+f:"")+(g?"; domain="+g:"")+(h?"; secure":"");document.cookie=a}return{setState:function(b,d){a(b,d)},getState:function(a){a=(a=document.cookie.match("(^|;) ?"+a+"=([^;]*)(;|$)"))?unescape(a[2]):null;return"false"==a?!1:"true"==a?!0:a},removeState:function(b){a(b,"")}}}();Banana.Util.DomHelper={};
...
a,!0)}});Banana.App=Banana.Application;var Application={Pages:{}};Application.Pages.PageTemplates={};Application.Pages.PageTemplates.PageTemplate={};

...
namespace("Application.Controls").HomeTileItemRender=Banana.Controls.DataGridTileItemRender.extend({createComponents:function(){this.panel=new Banana.Controls.Panel;this.panel.addCssClass("DemoHomeTile");var a=new Banana.Controls.Panel;a.addCssClass("DemoHomeTileTitle");a.addControl(this.data.title);var b=new Banana.Controls.Panel;b.addCssClass("DemoHomeTileContents");b.addControl(this.data.contents);var d=new Banana.Controls.Link;d.addControl("View");d.setHref("#section="+this.data.link);var e=new Banana.Controls.Panel;
e.addCssClass("DemoHomeTileLinkContainer");e.addControl(d);this.panel.addControl(a);this.panel.addControl(b);this.panel.addControl(e);this.addControl(this.panel)},updateDisplay:function(){this.panel.setCss({height:Math.round(0.8*this.panel.getDimensions().width)})},select:function(){this.panel.addCssClass("ExampleTileSimple2ItemRenderSelected")},deselect:function(){this.panel.removeCssClass("ExampleTileSimple2ItemRenderSelected")},getIsSelectable:function(){return!1}});Application.Pages.MyPage={};
...
var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth("33.28%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Table datagrid",link:"ewrwe",contents:"Table datagrid shows a vertical list of items devided in rows and columns."},{title:"Filterable",link:"ewrwe",contents:"Table datagrid with filterable components"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},
{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Dynamic data coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Dynamic updating the contents of the list"}]);return grid},getTileGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTileDataGrids");var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});
a.setPlaceHolderWidth("33.28%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Tile datagrid",link:"ewrwe",contents:"Tile datagrid in a simple form"},{title:"Selectables",link:"ewrwe",contents:"Selectable tiles"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Simulate data population coming from a server"},
{title:"dynamic updating contents",link:"ewrwe",contents:"Adding and removing tiles based on updated datasource"}]);return grid},getTreeGridOverview:function(){grid=new Banana.Controls.DataGrid;grid.addCssClass("DemoTreeDataGrids");var a=new Banana.Controls.DataGridTileListRender;a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth("33.28%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Table datagrid",link:"ewrwe",contents:"Table datagrid shows a vertical list of items devided in rows and columns."},
{title:"Filterable",link:"ewrwe",contents:"Table datagrid with filterable components"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},{title:"Dataset data provider",link:"ewrwe",contents:"Managing datasources with datasets"},{title:"Simulated dynamic data",link:"ewrwe",contents:"Dynamic data coming from a server"},{title:"dynamic updating contents",link:"ewrwe",contents:"Dynamic updating the contents of the list"}]);return grid}});

...
Banana.Util.CopyTo=function(a,b,d,e){if(a instanceof Array&&b instanceof Array)for(var f=b.splice(0,b.length),g=0,h=a.length;g<h;g++)if(e=a[g],"object"==typeof e){var k=e[d];if(k){for(var j=!1,p=0,m=f.length;p<m;p++){var r=f[p],v=r[d];if(v&&v==k){j=!0;b.push(r);Banana.Util.CopyTo(e,r,d,{ref:b,prop:g});break}}j||b.push(e)}else b.push(e)}else b[g]=e;else if(a instanceof Array)if(e)e.ref[e.prop]=a;else throw"Unable to assign property to object (missing reference)";else if("object"==typeof a){f=[];for(g in b)"function"!=
...
this.computeHSV=function(){var a=this.r/255,b=this.g/255,d=this.b/255,e=Math.min(a,b,d),f=Math.max(a,b,d),e=f-e,m=0,r=0;0!=f?(r=e/f,m=60*(e?a==f?(b-d)/e:b==f?2+(d-a)/e:4+(a-b)/e:0),0>m&&(m+=360)):(r=0,m=-1);this.h=m;this.s=r;this.v=f};this.computeRGB=function(){var a=this.h,b=this.s,d=this.v,f=0,p=0,m=0,r=0,f=m=p=0;if(0==b)e=f=m=d;else switch(a=a%360/60,f=Math.floor(a),p=a-f,m=d*(1-b),r=d*(1-b*p),p=d*(1-b*(1-p)),f){case 0:e=d;f=p;break;case 1:e=r;f=d;break;case 2:e=m;f=d;m=p;break;case 3:e=m;f=r;
m=d;break;case 4:e=p;f=m;m=d;break;default:e=d,f=m,m=r}this.r=Math.round(255*e);this.g=Math.round(255*f);this.b=Math.round(255*m)};"string"==typeof a?this.setValue(a):("number"==typeof a?(this.r=a,this.g=b,this.b=d):this.b=this.g=this.r=0,this.computeHSV())};/*
   xxx
 @version   0.0.1
 @package   Banana
...
h=[],j=e.length,p=null,m=e.length;a.each(e.split(""),function(a,b){"?"==b?(m--,j=a):k[b]?(h.push(RegExp(k[b])),null==p&&(p=h.length-1)):h.push(null)});return this.each(function(){function g(a){for(;++a<=m&&!h[a];)return a}function v(b){var e=a(this).caret(),b=b.keyCode;t=16>b||16<b&&32>b||32<b&&41>b;0!=e.begin-e.end&&(!t||8==b||46==b)&&x(e.begin,e.end);if(8==b||46==b||d&&127==b){for(e=e.begin+(46==b?0:-1);!h[e]&&0<=--e;){for(b=e;b<m;b++)if(h[b]){q[b]=f.placeholder;var j=g(b);if(j<m&&h[b].test(q[j]))q[b]=
q[j];else break}u();n.caret(Math.max(p,e))}return!1}if(27==b)return n.val(w),n.caret(0,s()),!1}function y(b){if(t)return t=!1,8==b.keyCode?!1:null;var b=b||window.event,d=b.charCode||b.keyCode||b.which,e=a(this).caret();if(b.ctrlKey||b.altKey||b.metaKey)return!0;if(32<=d&&125>=d||186<d)if(b=g(e.begin-1),b<m&&(d=String.fromCharCode(d),h[b].test(d))){for(var e=b,j=f.placeholder;e<m;e++)if(h[e]){var k=g(e),p=q[e];q[e]=j;if(k<m&&h[k].test(p))j=p;else break}q[b]=d;u();b=g(b);a(this).caret(b);f.completed&&
b==m&&f.completed.call(n)}return!1}function x(a,b){for(var d=a;d<b&&d<m;d++)h[d]&&(q[d]=f.placeholder)}function u(){return n.val(q.join("")).val()}function s(a){for(var b=n.val(),d=-1,e=0,g=0;e<m;e++)if(h[e]){for(q[e]=f.placeholder;g++<b.length;){var k=b.charAt(g-1);if(h[e].test(k)){q[e]=k;d=e;break}}if(g>b.length)break}else q[e]==b[g]&&e!=j&&(g++,d=e);if(!a&&d+1<j)n.val(""),x(0,m);else if(a||d+1>=j)u(),a||n.val(n.val().substring(0,d+1));return j?e:p}var n=a(this),q=a.map(e.split(""),function(a){if("?"!=
a)return k[a]?f.placeholder:a}),t=!1,w=n.val();n.data("buffer",q).data("tests",h);n.attr("readonly")||n.one("unmask",function(){n.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){w=n.val();var a=s();u();setTimeout(function(){a==e.length?n.caret(0,a):n.caret(a)},0)}).bind("blur.mask",function(){s();n.val()!=w&&n.change()}).bind("keydown.mask",v).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){n.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.DataControls.RadioButton={};namespace("Banana.Controls").RadioButton=Banana.Controls.InputControl.extend({init:function(){this._super();this.setAttribute("type","radio");this.addCssClass("BRadioButton")},setName:function(a){this.setAttribute("name",a);return this},setDomData:function(a){this.isRendered&&Banana.Util.DomHelper.setCheckBoxData(a,this);return this},getDomData:function(){if(this.isRendered)return Banana.Util.DomHelper.getCheckBoxData(this)}});Banana.Controls.DataControls.ProgressBar={};
...
this.getRenderedItemRenderByIndex(a))&&("function"==typeof a.select&&a.getIsSelectable())&&a.select()},deSelectIndex:function(a){(a=this.getRenderedItemRenderByIndex(a))&&"function"==typeof a.deselect&&a.deselect()}});Banana.Controls.DataGridTileItemRender={};
...
a.select()},deSelectIndex:function(a){(a=this.getRenderedItemRenderByIndex(a))&&"function"==typeof a.deselect&&a.deselect()}});Banana.Controls.DataGridTreeListHolder={};
...
(a[this.childKey]=[]);b instanceof Array||(b=[b]);var e=this.getNodeDataByData(a),f=0,g=a[this.childKey].length-e.addedChildren.length-1,h,k;h=0;for(k=b.length;h<k;h++){var j=b[h];this.toLogger("addDataSource",j,this.indexKey);var p=this.keyDataIndex[j[this.indexKey]];this.toLogger("addDataSource","use index",p);if(void 0!==p){this.toLogger("found existing remove from added, and add childcount");var m=e.addedChildren.indexOf(p);if(0<=m){e.addedChildren.splice(e.addedChildren.indexOf(m,1));f++;continue}}d||
e.addedChildren.push(j);if(this.sortFunc&&a[this.childKey][g]){var r=this.sortFunc(j,a[this.childKey][g]);this.toLogger("sort result of "+j.name+" and "+a[this.childKey][g].name+" ",r);0>r&&(this.toLogger("remove "+j.name+" from addedChildren, we are before the last one"),e.addedChildren.splice(e.addedChildren.indexOf(j),1),f++)}a[this.childKey].push(j)}this.toLogger("current childcount prop",e.childCount,"children",a[this.childKey].length);this.prepareSourceToRender(a)}catch(v){console.log(v)}},
...
q[j];else break}u();n.caret(Math.max(p,e));return!1}if(27==b)return n.val(w),n.caret(0,s()),!1}function y(b){if(t)return t=!1,8==b.keyCode?!1:null;var b=b||window.event,d=b.charCode||b.keyCode||b.which,e=a(this).caret();if(b.ctrlKey||b.altKey||b.metaKey)return!0;if(32<=d&&125>=d||186<d)if(b=g(e.begin-1),b<m&&(d=String.fromCharCode(d),h[b].test(d))){for(var e=b,j=f.placeholder;e<m;e++)if(h[e]){var k=g(e),p=q[e];q[e]=j;if(k<m&&h[k].test(p))j=p;else break}q[b]=d;u();b=g(b);a(this).caret(b);f.completed&&
b==m&&f.completed.call(n)}return!1}function x(a,b){for(var d=a;d<b&&d<m;d++)h[d]&&(q[d]=f.placeholder)}function u(){return n.val(q.join("")).val()}function s(a){for(var b=n.val(),d=-1,e=0,g=0;e<m;e++)if(h[e]){for(q[e]=f.placeholder;g++<b.length;){var k=b.charAt(g-1);if(h[e].test(k)){q[e]=k;d=e;break}}if(g>b.length)break}else q[e]==b[g]&&e!=j&&(g++,d=e);if(!a&&d+1<j)n.val(""),x(0,m);else if(a||d+1>=j)u(),a||n.val(n.val().substring(0,d+1));return j?e:p}var n=a(this),q=a.map(e.split(""),function(a){if("?"!=
a)return k[a]?f.placeholder:a}),t=!1,w=n.val();n.data("buffer",q).data("tests",h);n.attr("readonly")||n.one("unmask",function(){n.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){w=n.val();var a=s();u();setTimeout(function(){a==e.length?n.caret(0,a):n.caret(a)},0)}).bind("blur.mask",function(){s();n.val()!=w&&n.change()}).bind("keydown.mask",v).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){n.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.SwitchButton={};
...
populateGrid:function(){var a=this.getFilteredDataSource();this.pagerFilter.setDataSource(Math.ceil(a.length/this.pageSize));a=this.filterPageDataSource(a,this.filterManager.getFilterData());this.datagrid.setDataSource(a)},getColumns:function(){return[(new Banana.Controls.DataGridColumn).setHeaderText("Id").setDataField("id").setSortField("id"),(new Banana.Controls.DataGridColumn).setHeaderText("Name").setDataField("name").setSortField("name"),(new Banana.Controls.DataGridColumn).setHeaderText("Description").setDataField("description").setSortField("description"),
...
events:{onReady:this.getProxy(function(a){this.playerIsReady(a)}),onStateChange:this.getProxy(function(a){this.playerStateChanged(a)}),onError:this.getProxy(function(a){this.playerIsErrored(a)})}})})})({id:this.placeHolder.getClientId(),data:this.data,width:this.width,height:this.height})),this.isApiReady()))window.queuedBananaYouTubePlayers[window.queuedBananaYouTubePlayers.length-1]()},loadVideoById:function(a,b){this.getPlayer()?(this.duration=null,this.getPlayer().loadVideoById(a,b)):console.log(this.id,
"no player")},cueVideoById:function(a,b){this.getPlayer()?(this.duration=null,this.getPlayer().cueVideoById(a,b)):console.log(this.id,"no player")},setVolume:function(a){this.getPlayer()?this.getPlayer().setVolume(a):log.error("no player")},mute:function(){this.getPlayer()?(this.isMutedPasv=!0,this.getPlayer().mute()):log.error("no player")},unMute:function(){this.getPlayer()?(this.isMutedPasv=!1,this.getPlayer().unMute()):log.error("no player")},isMuted:function(a){return a?this.isMutedPasv:!this.getPlayer()?
(log.error("no player"),null):this.getPlayer().isMuted()},getDuration:function(){if(this.getPlayer())return this.getPlayer().getDuration();log.error("no player")},getCurrentTime:function(){if(this.getPlayer())return new Banana.Util.DateTimecode(1E3*this.getPlayer().getCurrentTime());log.error("no player")},getPlayerState:function(){if(this.getPlayer())return this.getPlayer().getPlayerState();log.error("no player")},seekTo:function(a,b){if(this.getPlayer())return this.getPlayer().seekTo(a,b);log.error("no player")},
playVideo:function(){if(this.getPlayer())return this.getPlayer().playVideo();log.error("no player")},pauseVideo:function(){if(this.getPlayer())return this.getPlayer().pauseVideo();log.error("no player")},stopVideo:function(){if(this.getPlayer())return this.getPlayer().stopVideo();log.error("no player")},getPlayer:function(){if(this.playerReady)return this.player;log.error("no player")},playerStateChanged:function(a){this.duration!=this.getDuration()&&(this.duration=this.getDuration(),this.triggerEvent("onDurationKnown",
new Banana.Util.DateTimecode(1E3*this.duration)));this.triggerEvent("onPlayerStateChanged",a)},playerIsReady:function(a){this.playerReady=!0;try{this.triggerEvent("onPlayerReady",a)}catch(b){console.log(b)}},playerIsErrored:function(a){this.triggerEvent("onPlayerError",a)}});Application.Controls.Datagrids.TilegridCustomItemRender={};
...
a.setItemRender(function(){return new Application.Controls.HomeTileItemRender});a.setPlaceHolderWidth(100/3+"%;");grid.setListRender(a);grid.setDataSource([{title:"Basic Tree datagrid",link:"Application.Controls.Datagrids.TreegridSimple",control:"Application.Controls.Datagrids.TreegridSimple",contents:"Tree datagrid. Shows basic tree grid with expand functionality."},{title:"Filterable",link:"ewrwe",contents:"Table datagrid with filterable components"},{title:"Custom item render",link:"ewrwe",contents:"To extend the interactivity you can define your own item render. "},

...
e.addCssClass("DemoHomeTileLinkContainer");e.addControl(d);this.addControl(a);this.addControl(b);this.addControl(e)},onGrown:function(){this.link.setVisible(!0,300,"fadeIn");if(this.data.control){var a=Banana.Util.NamespaceToFunction(this.data.control);if(a)a=new a,a.setVisible(!1),this.inst=a,a.setCss({height:this.contents.getDimensions().height+"px",overflow:"auto"}),this.contents.addControl(a,!0),a.setVisible(!0,300,"fadeIn")}},onShrinkStart:function(a){this.link.setVisible(!1,300);this.inst?this.inst.setVisible(!1,
100,"fadeOut",function(){a&&a()}):a&&a()}});

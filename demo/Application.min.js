...
a)return j[a]?f.placeholder:a}),t=!1,v=m.val();m.data("buffer",p).data("tests",h);m.attr("readonly")||m.one("unmask",function(){m.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){v=m.val();var a=s();u();setTimeout(function(){a==e.length?m.caret(0,a):m.caret(a)},0)}).bind("blur.mask",function(){s();m.val()!=v&&m.change()}).bind("keydown.mask",r).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){m.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.DataControls.RadioButton={};namespace("Banana.Controls").RadioButton=Banana.Controls.InputControl.extend({init:function(){this._super();this.setAttribute("type","radio");this.addCssClass("BRadioButton")},setName:function(a){this.setAttribute("name",a);return this},setDomData:function(a){this.isRendered&&Banana.Util.DomHelper.setCheckBoxData(a,this);return this},getDomData:function(){if(this.isRendered)return Banana.Util.DomHelper.getCheckBoxData(this)}});Banana.Controls.DataControls.ProgressBar={};
...
0,null);e||(this.setDataSource(this.datasource),this.triggerEvent("dataSourceChanged"))},addItemsAt:function(a,b,d){var e;for(e=0,len=a.length;e<len;e++)this.addItemAt(a[e],b,d,!0);this.setDataSource(this.datasource)},removeItem:function(a){a=this.datasource.indexOf(a);-1!=a&&this.removeRowByIndex(a);this.removeRowByIndex(a)},removeItemByItemRender:function(a){this.removeRowByIndex(this.indexRenderedItemRenderMap.indexOf(a))},removeAllItems:function(){this._super()},getDefaultItemRender:function(){return this.defaultContentItemRender},
setItemRenderByIndex:function(a,b,d,e){this.indexItemRenderFactory[a]=b;!e&&this.datasource[a]&&this.datasource[a][this.indexKey]&&this.dataItemRenderMap.addItem(this.datasource[a][this.indexKey],b);d||(this.clearRowByIndex(a),this.createItemRenderByIndex(a,!0),this.triggerEvent("itemRenderChanged"))},setItemRenderByIndices:function(a,b){if(a.length){var d=4<a.length,e;for(e=0;e<a.length;e++)this.setItemRenderByIndex(a[e],b,d);d&&(this.triggerEvent("itemRenderChanged"),this.rerender())}},setItemRender:function(a){this.dataItemRenderMap.clear();
var b;for(b=0,clen=this.indexRenderedItemRenderMap.length;b<clen;b++)this.setItemRenderByIndex(b,a,!0);this.mainContainer?(this.mainContainer.clear(),this.createItems(),this.isRendered&&this.mainContainer.invalidateDisplay()):this.defaultContentItemRender=a;this.triggerEvent("itemRenderChanged")},getRenderedItemRenderByIndex:function(a){return this.indexRenderedItemRenderMap[a]},rerenderIndex:function(a){this.previousSelectedItems=this.getSelectedItems();this.indexTilePlaceHolderMap[a].clear();this.createItemRenderByIndex(a,
!0);this.setSelectedItems(this.previousSelectedItems)},getRenderedItemRenderByData:function(){},hasItemRenderAt:function(a,b){return this.indexRenderedItemRenderMap[a]instanceof b?!0:!1},removeRowByIndex:function(a){this.datasource.splice(a,1);this.indexTilePlaceHolderMap[a].remove();this.selectedIndices.remove(i);this.indexTilePlaceHolderMap.splice(a,1);this.indexItemRenderFactory.splice(a,1);this.indexRenderedItemRenderMap.splice(a,1);this.triggerEvent("dataSourceChanged")},clearRowByIndex:function(a){this.indexTilePlaceHolderMap[a].clear()},
getIndexByRow:function(a){return this.indexTilePlaceHolderMap.indexOf(a)},getIndexByItemRender:function(a){return this.indexTilePlaceHolderMap.indexOf(a.parent)},createControls:function(){this.setupIndexing();this.previousSelectedItems=this.getSelectedItems();this.selectedIndices.clear();this._super();this.mainContainer=new Banana.Controls.Panel;this.mainContainer.bind("mousedown",this.getProxy(function(a){(a.originalEvent.shiftKey||a.originalEvent.ctrlKey)&&a.preventDefault()}));this.createItemsLater=
!1;this.horizontalItemCount&&this.isRendered?this.createItems():this.horizontalItemCount&&!this.isRendered?this.createItemsLater=!0:this.createItems();this.addControl(this.mainContainer);this.setSelectedItems(this.previousSelectedItems)},updateDisplay:function(){if(this.createItemsLater&&this.getDemensions().width)this.createItemsLater=!1,this.createItems(),this.mainContainer.invalidateDisplay()},createItems:function(){if(this.datasource.length){var a;for(a=0,len=this.datasource.length;a<len;a++)this.applyUid(this.datasource[a]),
this.createDivPlaceHolder(a),this.triggerEvent("onPreCreateItemRender",{index:a,data:this.datasource[a]}),this.createItemRenderByIndex(a);this.mainContainer.addControl("<div style='clear:both'></div>");this.cachedDemensions=null}},setHorizontalTileCount:function(a){this.horizontalItemCount=a;return this},setTilePadding:function(a){this.tilePadding=a;return this},createDivPlaceHolder:function(a,b){var d="width:auto;padding:0;float:left;position:relative;";if(this.horizontalItemCount&&1<this.horizontalItemCount){if(!this.cachedDemensions)this.cachedDemensions=
this.getDemensions();var d=(this.getDemensions().width-this.horizontalItemCount*this.tilePadding)/this.horizontalItemCount-2,e=this.tilePadding,d=0===a%this.horizontalItemCount?"width:"+d+"px;float:left;margin-left:"+e/2+"px;clear:left;":"width:"+d+"px;float:left;margin-left:"+e+"px;"}else d="width:100%;float:left;position:relative;";d=(new Banana.Controls.Panel).setStyle(d);d.addCssClass("BDataGridTilePlaceHolder");d.bind("mouseenter",this.getProxy(function(a){this.onRowMouseOver(a);return!0}),d);
d.bind("mouseleave",this.getProxy(function(a){this.onRowMouseOut(a);return!0}),d);d.bind("click",this.getProxy(function(a){this.onRowMouseClick(a);return!0}),d);this.mainContainer.addControl(d,b);b&&this.mainContainer.invalidateDisplay();this.indexTilePlaceHolderMap[a]=d},createItemRenderByIndex:function(a,b){this.currentIndexCreation=a;var d=null,e=this.datasource[a][this.indexKey],d=e&&this.dataItemRenderMap.getItem(e)?this.dataItemRenderMap.getItem(e):this.indexItemRenderFactory[a]?this.indexItemRenderFactory[a]:
this.defaultContentItemRender,e=this.getObject(d);e.setData(this.datasource[a]);e.bind("dataChanged",this.getProxy(function(a){this.getDataSource()[parseInt(a.data,10)]=a.currentTarget.getData();this.triggerEvent("dataSourceChanged")}),a.toString());this.dataItemRenderMap.addItem(this.datasource[a][this.indexKey],d);this.indexRenderedItemRenderMap[a]=e;e.setListRender(this);d=this.indexTilePlaceHolderMap[a];d.addControl(e);b&&d.invalidateDisplay();this.currentIndexCreation=void 0},onRowMouseOver:function(a){this.indexRenderedItemRenderMap[this.indexTilePlaceHolderMap.indexOf(a.data)].getIsSelectable()&&
jQuery(a.currentTarget).addClass("datagridmouseover")},onRowMouseOut:function(a){this.indexRenderedItemRenderMap[this.indexTilePlaceHolderMap.indexOf(a.data)].getIsSelectable()&&jQuery(a.currentTarget).removeClass("datagridmouseover")},onRowMouseClick:function(a){var b=this.indexTilePlaceHolderMap.indexOf(a.data);if(this.indexRenderedItemRenderMap[b].getIsSelectable()&&!(0>b)){var d=a.ctrlKey,a=a.shiftKey;if(this.getIndexIsSelected(b))!d&&!a?this.clearSelectedIndices():this.clearSelectedIndex(b);
else if("single"===this.selectionType)this.clearSelectedIndices(),this.addSelectedIndex(b);else if(!d&&!a&&(this.clearSelectedIndices(),this.addSelectedIndex(b)),d&&this.addSelectedIndex(b),a){(d=parseInt(this.selectedIndices.getKeyByIndex(0),10))||(d=0);b>d||(d=b,b=parseInt(this.selectedIndices.getKeyByIndex([this.selectedIndices.getLength()-1]),10));this.clearSelectedIndices();for(d=parseInt(d,10);d<=parseInt(b,10);d++)this.addSelectedIndex(d)}this.triggerEvent("onItemSelect")}},selectIndex:function(a){var b=
this.getRenderedItemRenderByIndex(a);b&&"function"==typeof b.select&&b.getIsSelectable()&&b.select();this.indexTilePlaceHolderMap[a].addCssClass("BDataGridRowSelected")},deSelectIndex:function(a){var b=this.getRenderedItemRenderByIndex(a);b&&"function"==typeof b.deselect&&b.deselect();this.indexTilePlaceHolderMap[a].removeCssClass("BDataGridRowSelected")}});Banana.Controls.DataGridTreeListHolder={};
...
p[j];else break}u();m.caret(Math.max(n,e));return!1}if(27==b)return m.val(v),m.caret(0,s()),!1}function y(b){if(t)return t=!1,8==b.keyCode?!1:null;var b=b||window.event,d=b.charCode||b.keyCode||b.which,e=a(this).caret();if(b.ctrlKey||b.altKey||b.metaKey)return!0;if(32<=d&&125>=d||186<d)if(b=g(e.begin-1),b<o&&(d=String.fromCharCode(d),h[b].test(d))){for(var e=b,j=f.placeholder;e<o;e++)if(h[e]){var k=g(e),n=p[e];p[e]=j;if(k<o&&h[k].test(n))j=n;else break}p[b]=d;u();b=g(b);a(this).caret(b);f.completed&&
b==o&&f.completed.call(m)}return!1}function w(a,b){for(var d=a;d<b&&d<o;d++)if(h[d])p[d]=f.placeholder}function u(){return m.val(p.join("")).val()}function s(a){for(var b=m.val(),d=-1,e=0,g=0;e<o;e++)if(h[e]){for(p[e]=f.placeholder;g++<b.length;){var j=b.charAt(g-1);if(h[e].test(j)){p[e]=j;d=e;break}}if(g>b.length)break}else p[e]==b[g]&&e!=k&&(g++,d=e);if(!a&&d+1<k)m.val(""),w(0,o);else if(a||d+1>=k)u(),a||m.val(m.val().substring(0,d+1));return k?e:n}var m=a(this),p=a.map(e.split(""),function(a){if("?"!=
a)return j[a]?f.placeholder:a}),t=!1,v=m.val();m.data("buffer",p).data("tests",h);m.attr("readonly")||m.one("unmask",function(){m.unbind(".mask").removeData("buffer").removeData("tests")}).bind("focus.mask",function(){v=m.val();var a=s();u();setTimeout(function(){a==e.length?m.caret(0,a):m.caret(a)},0)}).bind("blur.mask",function(){s();m.val()!=v&&m.change()}).bind("keydown.mask",r).bind("keypress.mask",y).bind(b,function(){setTimeout(function(){m.caret(s(!0))},0)});s()})}})})(jQuery);Banana.Controls.SwitchButton={};
...
a.addControl(b)},createSubs:function(){var a=new Banana.Controls.Panel;a.addCssClass("buttonPanel");var b=(new Banana.Controls.Panel).addCssClass("menusub");a.addControl(b);var d=new Banana.Controls.Link;d.addCssClass("menusublink");d.addControl("Examples");d.bind("click",this.getProxy(function(a){console.log("click");Banana.Application.loadPage("Example");a.preventDefault()}));d.setHref("#section=Examples");b.addControl(d);b=(new Banana.Controls.Panel).addCssClass("menusub").addCssClass("menusub2");
...
a.addControl(b);a=new Banana.Controls.Panel;a.addControl(".");a.addCssClass("cube");a=new Banana.Controls.Panel;a.addControl(".");a.addCssClass("cube");a=new Banana.Controls.Panel;a.addControl(".");a.addCssClass("cube")},updateDisplay:function(){}});

...
b.addControl(d)},createSubs:function(){var b=new Banana.Controls.Panel;b.addCssClass("buttonPanel");var d=(new Banana.Controls.Panel).addCssClass("menusub");b.addControl(d);var e=new Banana.Controls.Link;e.addCssClass("menusublink");e.addControl("Examples");d.addControl(e);d=(new Banana.Controls.Panel).addCssClass("menusub").addCssClass("menusub2");b.addControl(d);e=new Banana.Controls.Link;e.addCssClass("menusublink");e.addControl("Download");d.addControl(e);d=(new Banana.Controls.Panel).addCssClass("menusub").addCssClass("menusub3");
b.addControl(d);e=new Banana.Controls.Link;e.addCssClass("menusublink");e.addControl("Documentation");d.addControl(e);this.right.addControl(b)},createRands:function(){var b=new Banana.Controls.Panel;b.addCssClass("bottom");this.addControl(b);var d=new Banana.Controls.Panel;d.addCssClass("summaryText");d.addControl("Banana is an opensource javascript application framework designed to create pure javascript webpages. Banana is designed with the single goal to help developers write fast and efficient websites.Compatible with all major browsers, Banana gives developers a component driven platform to develop applications just in the same way regular interface toolkits provides.");

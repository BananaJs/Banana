...
// check if owl is included in banana
goog.provide('Banana.thirdParty.OWLClone');
...
owl = (function() {
	...
	DeepCopyAlgorithm.prototype = {
		...
		applyDeepCopier: function(deepCopier, source) {
			...
			// start pushing the objectmapper into the clone
			// TODO: This is ObjectMapper specific code. Be aware when updating this file
			if (source instanceof Banana.Data.BaseObject)
			{
				// the source object is an object with functions
				// recreate the functions
				var resultObject = Banana.Data.ObjectMapper.getObject(source.getClass());
				var x;
				for (x in result)
				{
					resultObject[x] = result[x];
				}
				result = resultObject;
			}
